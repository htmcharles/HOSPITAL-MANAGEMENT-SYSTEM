		...
		<div class="container">
			...
			<div class="nav-collapse">
				...
				<li class="">			
					...
					{
					?>
						<a href="hospForm.php?english=english<?php if(isset($_GET['num'])){ echo '&num='.$_GET['num'].'';}?><?php if(isset($_GET['updateidPahosp'])){ echo '&updateidPahosp='.$_GET['updateidPahosp'];} if(isset($_GET['inf'])){ echo '&inf='.$_GET['inf'];}?><?php if(isset($_GET['idhosp'])){ echo '&idhosp='.$_GET['idhosp'];}?>" class="btn"><?php echo getString(30);?></a>
					<?php
					}else{
					?>
						<a href="hospForm.php?francais=francais<?php if(isset($_GET['num'])){ echo '&num='.$_GET['num'].'';}?><?php if(isset($_GET['updateidPahosp'])){ echo '&updateidPahosp='.$_GET['updateidPahosp'];} if(isset($_GET['inf'])){ echo '&inf='.$_GET['inf'];}?><?php if(isset($_GET['idhosp'])){ echo '&idhosp='.$_GET['idhosp'];}?>" class="btn"><?php echo getString(29);?></a>
					<?php
					}					
					?>
						<br/>						
		...
		?>
			<div id="formHosp" style="margin-top:50px">	
				...
				<table cellspacing="0" align="center">
					...
					<tr>
						<td><label for="roomnumber"><?php echo 'Numero de salle';?></label></td>
						<td>
							<select name="roomnumber" id="roomnumber" onchange="ShowLit('room')">
								<option value=""><?php echo 'Selectionner la salle...';?></option>
								<?php

								$resultats=$connexion->query('SELECT *FROM rooms WHERE statusA!=1 OR statusB!=1 OR statusC!=1 OR statusD!=1 OR statusE!=1 OR statusF!=1 OR statusG!=1 OR statusH!=1 OR statusI!=1 OR statusJ!=1 OR statusK!=1 OR statusL!=1 OR statusM!=1 OR statusN!=1 ORDER BY id_room');
						...
						$results=$connexion->query('SELECT *FROM rooms WHERE (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG=1 AND statusH=1 AND statusI=1 AND statusJ=1 AND statusK=1 AND statusL=1 AND statusM=1 AND statusN=1) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG=1 AND statusH=1 AND statusI=1 AND statusJ=1 AND statusK=1 AND statusL=1 AND statusM=1 AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG=1 AND statusH=1 AND statusI=1 AND statusJ=1 AND statusK=1 AND statusL=1 AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG=1 AND statusH=1 AND statusI=1 AND statusJ=1 AND statusK=1 AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG=1 AND statusH=1 AND statusI=1 AND statusJ=1 AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG=1 AND statusH=1 AND statusI=1 AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG=1 AND statusH=1 AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG=1 AND statusH IS NULL AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF=1 AND statusG IS NULL AND statusH IS NULL AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE=1 AND statusF IS NULL AND statusG IS NULL AND statusH IS NULL AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD=1 AND statusE IS NULL AND statusF IS NULL AND statusG IS NULL AND statusH IS NULL AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC=1 AND statusD IS NULL AND statusE IS NULL AND statusF IS NULL AND statusG IS NULL AND statusH IS NULL AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB=1 AND statusC IS NULL AND statusD IS NULL AND statusE IS NULL AND statusF IS NULL AND statusG IS NULL AND statusH IS NULL AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) OR (statusA=1 AND statusB IS NULL AND statusC IS NULL AND statusD IS NULL AND statusE IS NULL AND statusF IS NULL AND statusG IS NULL AND statusH IS NULL AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL) ORDER BY numroom');
			...
			<div id="formHosp" style="margin-top:50px">	
				...
				<table cellspacing="0" align="center">
					...
					<tr>
						...
						$results=$connexion->query('SELECT *FROM rooms WHERE statusA=1 AND statusB IS NULL AND statusC IS NULL AND statusD IS NULL AND statusE IS NULL AND statusF IS NULL AND statusG IS NULL AND statusH IS NULL AND statusI IS NULL AND statusJ IS NULL AND statusK IS NULL AND statusL IS NULL AND statusM IS NULL AND statusN IS NULL ORDER BY numroom');
				...
				<tr>
					...
					<td>
						...
						{							
							if($reponse['statusA']==0 OR $numlitEdit=="1")
							{
						?>	
								<option value='1' <?php if($numlitEdit=="1"){ echo 'selected="selected"';}?>>1</option>
						<?php
							}
							
							if($reponse['statusB']!=NULL)
							{
								if($reponse['statusB']==0 OR $numlitEdit=="2")
								{
							?>
									<option value='2' <?php if($numlitEdit=="2"){ echo 'selected="selected"';}?>>2</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusC']==0 OR $numlitEdit=="3")
								{
							?>
									<option value='3' <?php if($numlitEdit=="3"){ echo 'selected="selected"';}?>>3</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusD']==0 OR $numlitEdit=="4")
								{
							?>
									<option value='4' <?php if($numlitEdit=="4"){ echo 'selected="selected"';}?>>4</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusE']==0 OR $numlitEdit=="5")
								{
							?>
									<option value='5' <?php if($numlitEdit=="5"){ echo 'selected="selected"';}?>>5</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusF']==0 OR $numlitEdit=="6")
								{
							?>
									<option value='6' <?php if($numlitEdit=="6"){ echo 'selected="selected"';}?>>6</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusG']==0 OR $numlitEdit=="7")
								{
							?>
									<option value='7' <?php if($numlitEdit=="7"){ echo 'selected="selected"';}?>>7</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusH']==0 OR $numlitEdit=="8")
								{
							?>
									<option value='8' <?php if($numlitEdit=="8"){ echo 'selected="selected"';}?>>8</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusI']==0 OR $numlitEdit=="9")
								{
							?>
									<option value='9' <?php if($numlitEdit=="9"){ echo 'selected="selected"';}?>>9</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusJ']==0 OR $numlitEdit=="10")
								{
							?>
									<option value='10' <?php if($numlitEdit=="10"){ echo 'selected="selected"';}?>>10</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusK']==0 OR $numlitEdit=="11")
								{
							?>
									<option value='11' <?php if($numlitEdit=="11"){ echo 'selected="selected"';}?>>11</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusL']==0 OR $numlitEdit=="12")
								{
							?>
									<option value='12' <?php if($numlitEdit=="12"){ echo 'selected="selected"';}?>>12</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusM']==0 OR $numlitEdit=="13")
								{
							?>
									<option value='13' <?php if($numlitEdit=="13"){ echo 'selected="selected"';}?>>13</option>
									<?php
								}
							}
							...
							{
								if($reponse['statusN']==0 OR $numlitEdit=="14")
								{
							?>
									<option value='14' <?php if($numlitEdit=="14"){ echo 'selected="selected"';}?>>14</option>
									<?php
								}
							}
						}
