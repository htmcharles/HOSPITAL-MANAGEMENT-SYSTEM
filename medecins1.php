...
if($connect==true AND ($comptidM!=0 OR $comptidA!=0) OR $_SESSION['dataM']!=NULL)
{
	if($status==1)
	{
	...
	<div class="navbar-inner">
		...
		<div class="container">
			...
			<div class="nav-collapse">
				...
				<li class="">			
					<form method="post" action="medecins1.php?<?php if(isset($_GET['codeM'])){ echo 'codeM='.$_GET['codeM'];}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" onsubmit="return controlFormPassword(this)">
					...
					{
					?>
						<a href="medecins1.php?english=english<?php if(isset($_GET['codeM'])){ echo '&codeM='.$_GET['codeM'];}if(isset($_GET['iduti'])){ echo '&iduti='.$_GET['iduti'];}if(isset($_GET['divMed'])){ echo '&divMed='.$_GET['divMed'];}?>" class="btn"><?php echo getString(30);?></a>
					<?php
					}else{
					?>
						<a href="medecins1.php?francais=francais<?php if(isset($_GET['codeM'])){ echo '&codeM='.$_GET['codeM'];}if(isset($_GET['iduti'])){ echo '&iduti='.$_GET['iduti'];}if(isset($_GET['divMed'])){ echo '&divMed='.$_GET['divMed'];}?>" class="btn"><?php echo getString(29);?></a>
					<?php
					}					
					?>
						<br/>						
...
$(document).ready( function() {
  ...
  $('#q').keyup( function(){
	...
	url : 'traitement_medecins1.php?name=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>' , // url du fichier de traitement
...
$(document).ready( function() {
  ...
  $('#s').keyup( function(){
	...
	url : 'traitement_medecins1.php?sn=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>' , // url du fichier de traitement
	...
	if(isset($_GET['divMed']))
	{
		...
		if($comptidA!=0)
		{
			$resultatsA=$connexion->prepare('SELECT *FROM utilisateurs u, medecins m, grades g, categopresta cp, servicemed sm WHERE u.id_u=m.id_u AND g.id_grade=cp.id_grade AND sm.id_categopresta=cp.id_categopresta AND sm.codemedecin=m.codemedecin AND m.id_u=:idMed AND u.id_u=:idMed');
		...
		if($comptidM!=0)
		{
			$resultatsM=$connexion->prepare('SELECT *FROM utilisateurs u, medecins m, grades g, categopresta cp, servicemed sm WHERE u.id_u=m.id_u AND g.id_grade=cp.id_grade AND sm.id_categopresta=cp.id_categopresta AND sm.codemedecin=m.codemedecin AND m.id_u=:idMed AND u.id_u=:idMed');
		...
		<table class="tablesorter" cellspacing="0" style="background-color:#FFF;width:100%;margin-bottom:20px;">
			...
			<tbody>
				...
				<tr style="text-align:center;<?php if($ligneM->status==0){?>background:rgb(253,168,170)<?php ;}?>"> 
					<td><?php echo $ligneM->codemedecin;?></td>
					<td><?php echo $ligneM->nom_u.' '.$ligneM->prenom_u;?></td>
					<td><?php echo $ligneM->nomgrade;?></td>
					
					<td>
					<?php
						if($ligneM->nomcategopresta !="Consultations")
						{
							echo $ligneM->nomcategopresta;
						}else{
							echo '';
						}
					?>
					...
					{
					?>
					<td style="color:blue;"><?php echo $ligneM->password;?></td>
					<?php
					}
					?>
					...
					<td><?php echo $ligneM->dateaffectationmed;?></td>
					
					<?php
					if($ligneM->status==1 AND $_SESSION['dataM']==NULL)
					{
					?>
					<td>
						<a href="utilisateurs.php?iduti=<?php echo $ligneM->id_u?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>"><input type="image" src="images/icn_edit.png" title="Modifier"/></a>
					</td>

					<td>
						<a href="report.php?med=<?php echo $ligneM->id_u;?>&coordi=<?php echo $_SESSION['id'];?>&report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn"><?php echo getString(94);?></a>
					</td>
						
					<td>
						<a href="traitement_utilisateurs.php?idutiDesactif=<?php echo $ligneM->id_u?>&code=<?php echo $ligneM->codemedecin;?><?php if(isset($_GET['page'])){ echo '&page='.$_GET['page'];}else{ echo '&page=1';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>">Activé<input type="image" style="border-radius:100px;" src="images/onBlue.png" name="desactifbtn"/></a>
					...
					?>
							...
							<td>
								<a href="reportDataM.php?med=<?php echo $ligne->id_u;?>&coordi=<?php echo $_SESSION['id'];?>&report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn"><?php echo getString(94);?></a>
							</td>
		...
		<table class="tablesorter" cellspacing="0" style="background-color:#FFF;width:100%;margin-bottom:20px;">
			...
			<tbody>
				...
				<tr style="text-align:center;<?php if($ligneA->status==0){?>background:rgb(253,168,170)<?php ;}?>"> 
					<td><?php echo $ligneA->codemedecin;?></td>
					...
					<td><?php echo $ligneA->nomgrade;?></td>
					<td><?php echo $ligneA->nomcategopresta;?></td>
					<td>
						<a href="report.php?med=<?php echo $ligneA->id_u;?>&audit=<?php echo $_SESSION['id'];?>&report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="<?php if($ligneA->status==0){ echo "display:none";}?>" class="btn"><?php echo getString(94);?></a>
					</td>
...
/* 
			...
			$resultats=$connexion->query('SELECT *FROM utilisateurs u, medecins m, grades g, categopresta_ins cp, servicemed sm WHERE u.id_u=m.id_u and g.id_grade=cp.id_grade and sm.id_categopresta=cp.id_categopresta and sm.codemedecin=m.codemedecin ORDER BY u.nom_u LIMIT '.$limit_start.', '.$pagination.'') or die( print_r($connexion->errorInfo()));
			...
			?>
				<tr style="text-align:center;<?php if($ligne->status==0){?>background:rgb(253,168,170)<?php ;}?>"> 
					<td><?php echo $ligne->codemedecin;?></td>
					<td><?php echo $ligne->nom_u.' '.$ligne->prenom_u;?></td>
					<td><?php echo $ligne->nomgrade;?></td>
					
					<td>
					<?php
						if($ligne->nomcategopresta !="Consultations")
						{
							echo $ligne->nomcategopresta;
						}else{
							echo '';
						}
					?>
					...
					{
					?>
					<td style="color:blue;font-size: 10px;width: 20px;">
					<?php
					if($_SESSION['ceo']!=1){
						$options = [
						    'cost' => 5,
						];
						$pass = password_hash($ligne->password, PASSWORD_DEFAULT,$options); 
						echo limit_word($pass,7);
					}else{
						echo $ligne->password;
					}
					...
					<td><?php echo $ligne->dateaffectationmed;?></td>
					
					<?php
					if($ligne->status==1 AND $_SESSION['dataM']==NULL)
					{
					?>
					<td>
						<a href="utilisateurs.php?iduti=<?php echo $ligne->id_u?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>"><input type="image" src="images/icn_edit.png" title="Modifier"/></a>
					</td>
					
					<td>
						<a href="report.php?med=<?php echo $ligne->id_u;?>&coordi=<?php echo $_SESSION['id'];?>&report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn"><?php echo getString(94);?></a>
					</td>
								
					<td>
						<a href="traitement_utilisateurs.php?idutiDesactif=<?php echo $ligne->id_u?>&code=<?php echo $ligne->codemedecin;?><?php if(isset($_GET['page'])){ echo '&page='.$_GET['page'];}else{ echo '&page=1';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>">Activé<input type="image" style="border-radius:100px;" src="images/onBlue.png" name="desactifbtn"/></a>
					...
					?>
						...
						<td>
							<a href="traitement_utilisateurs.php?idutiActif=<?php echo $ligne->id_u?>&code=<?php echo $ligne->codemedecin;?><?php if(isset($_GET['page'])){ echo '&page='.$_GET['page'];}else{ echo '&page=1';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>">Desactivé<input type="image" style="border-radius:100px;" src="images/offBlue.png" name="actifbtn"/></a>
	...
	<tr>
		...
		$nb_total=$connexion->query('SELECT COUNT(*) AS nb_total FROM utilisateurs u, medecins m, grades g, categopresta cp, servicemed sm WHERE u.id_u=m.id_u and g.id_grade=cp.id_grade and sm.id_categopresta=cp.id_categopresta and sm.codemedecin=m.codemedecin ORDER BY u.nom_u');
