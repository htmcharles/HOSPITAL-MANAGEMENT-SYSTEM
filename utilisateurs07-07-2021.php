	...
	<form method="post" action="traitement_utilisateurs.php?<?php if(isset($_GET['num'])){ echo 'num='.$_GET['num'];}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" onsubmit="return controlFormUser(this)" enctype="multipart/form-data" class="formlogin">
		...
		<div class="add-user">
			...
			<hr>
				...
				<!-- <input type="text" name="assu" value="1" id="asuu"> -->
			...
			?>
				...
				<table id="sect" style="display:none; margin-left:157px;">
				<tr>
					<td style="width:50px;"><?php echo getString(43);?></td>
					<td>
						<select style="width:300px;" name="secteur" id="secteur">
			...
			?>	
				...
				<table id="distri" style="<?php if($adresseExt!=""){ echo 'display:none;';}else{ echo 'display:inline-block;';}?>">
				<tr>
				...
				<table id="sect" style="<?php if($adresseExt!=""){ echo 'display:none;';}else{ echo 'display:inline-block;';}?>">
				<tr>
				...
				<table id="autreAdress" style="<?php if($adresseExt==""){ echo 'display:none;';}else{ echo 'display:inline-block;';}?>">
...
<div>
	...
	function ShowAssurance(assure)
	{
		...
		// document.getElementById('asuu').value = assurance;
