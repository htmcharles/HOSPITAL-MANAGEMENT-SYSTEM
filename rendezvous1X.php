...
?>
	...
	?>
		<a href="patients1.php?receptioniste=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn-large" name="savebtn" style="font-size:20px;height:40px;paddin:10px 40px;">
			<?php echo 'Reception';?>
		</a>
	<?php
	}
...
<?php
	...
	<div style="text-align:center;margin-top:20px;">
		...
		<a href="reportDataM.php?dataMan=ok<?php if(isset($_GET['receptioniste'])){ echo '&receptioniste=ok';} if(isset($_GET['caissier'])){ echo '&caissier=ok';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn-large-inversed" name="reportsbtn" style="font-size:20px;height:40px; padding:10px 40px;margin-right:10px;">
...
<div  class="account-container" style="width:80%;margin:auto; text-align:center;">
	...
	{
	?>
	<div style="background:#e8e8e8; margin-top:10px; padding:10px 50px; text-align:center;">
		...
		<form action="traitement_rendezvous.php" onsubmit="return controlFormRDV(this)" method="post" enctype="multipart/form-data">
			...
			<table class="cons-info" cellpadding=10 style="margin:0;margin:20px auto auto auto;background:#eee;width:90%;">
				
				<tr>
					<td style="text-align:right;">Patient</td>
					<td style="text-align:left;">
						<select name="numPa" id="numPa" class="chosen-select">
						<?php
				...
				<tr>
					...
					<td style="text-align:left;">	
						...
						{
						?>
						<option value="<?php echo $ligne->id_u;?>" <?php if($comptRdv!=0 AND $idmedRdv==$ligne->id_u) echo 'selected="selected"';?>><?php echo $ligne->full_name;?></option>
			...
			<table class="cons-info" style="background:#e8e8e8;border: none;margin-top:10px;" align="center">
		...
		?>
			...
			<table class="tablesorter" cellspacing="0" style="background-color:#FFF;width:100%;margin-bottom:20px;">
				...
				try
				{
					...
					?>
						<tr> 
							<td style="text-align:center;font-weight:bold;"><?php echo $ligne->daterdv;?></td>
