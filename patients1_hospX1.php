...
?>
				<tr style="text-align:center;">
					...
					if($comptMedConsult!=0 OR $comptMedInf!=0 OR $comptMedLabo!=0 OR $comptMedConsom!=0 OR $comptMedMedoc!=0 OR $comptMedRadio!=0)
					{
					?>	
