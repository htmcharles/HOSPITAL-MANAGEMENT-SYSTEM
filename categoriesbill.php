	...
	<table style="width:100%;margin:20px;">
		...
		?>
			...
			<td style="text-align:center"><?php echo 'Today date';?>
				...
				<input size="25px" type="hidden" id="idtypeconsu" name="idtypeconsu" value="<?php echo $_GET['idtypeconsu'];?>"/>
			</td>
		</tr>
			...
			<form method="post" action="printBill.php?num=<?php echo $_GET['num'];?>&idbill=&cashier=<?php echo $_GET['cashier'];?>&idconsu=<?php echo $_GET['idconsu'];?>&idmed=<?php echo $_GET['idmed'];?>&dateconsu=<?php echo $_GET['dateconsu'];?>&idtypeconsu=<?php echo $_GET['idtypeconsu'];?>&idassu=<?php echo $_GET['idassu'];?><?php if(isset($_GET['newdette'])){ echo '&newdette='.$_GET['newdette'];}?><?php if(isset($_GET['datefacture'])){ echo $_GET['datefacture'];}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&createfacture=0" onsubmit="return controlFormCategoBill(this)" enctype="multipart/form-data">
				...
				<table align="center">	   
					<tr>	   
						...
						<td>
						<p class="patientId">
							<input size="25px" type="text" id="vouchernum" name="vouchernum" onclick="ds_sh(this);" value="<?php echo $vouchernum;?>" placeholder="Enter here..." />
						</p>
						</td>
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td>		
								...
								?>						
								<input type="text" name="prixtypeconsult[]" style="width:100px;" id="prixtypeconsult<?php echo $i;?>" class="prixtypeconsult" value="<?php echo $lignePresta->prixpresta;?>"/>	<!-- 								
							...
							<td>			
								...
								?>					
								<input type="text" name="prixtypeconsult[]" style="width:100px; text-align:center" id="prixtypeconsult<?php echo $i;?>" class="prixtypeconsult" value="<?php echo $lignePresta->prixpresta;?>"/>	
<!-- 
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td>			
								...
								?>						
								<input type="text" name="prixprestaConsu[]" style="width:100px;" id="prixprestaConsu<?php echo $i;?>" class="prixprestaConsu" value="<?php echo $lignePresta->prixpresta;?>"/><!-- 					
							...
							<td>	
								...
								?>								
								<input type="text" name="prixprestaConsu[]" style="width:100px; text-align:center" id="prixprestaConsu<?php echo $i;?>" class="prixprestaConsu" value="<?php echo $lignePresta->prixpresta;?>"/><!-- 							
							...
							<td>
								<?php
									if ($lignePresta->prixpresta == 0 AND $lignePresta->statupresta == 1)
									{
										...
										echo "<label class='badge'>The price of this act is not sure!! Check price (New act or act doesn't exit in tarriff)</label>" ;
									}elseif ($lignePresta->prixpresta != 0 AND $lignePresta->statupresta == 2) {
										echo "<label class='badge'>This acts is not covered by insurance!</label>" ;
									}
								?>									
								<input type="text" name="prixprestaSurge[]" style="width:100px; text-align:center" id="prixprestaSurge" class="prixprestaSurge" value="<?php echo $lignePresta->prixpresta;?>"/><!-- 							
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td>		
								...
								?>							
								<input type="text" name="prixprestaKine[]" style="width:100px; text-align:center" id="prixprestaKine" class="prixprestaKine" value="<?php echo $lignePresta->prixpresta; ?>"/><!-- 			
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td>
								...
								?>	
								<input type="text" name="prixprestaOrtho[]" style="width:100px; text-align:center" id="prixprestaOrtho" class="prixprestaOrtho" value="<?php echo $lignePresta->prixpresta;?>"/>
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							for($i=1;$i<=$assuCount;$i++)
							{
								...
								{
									$presta_assuPyscho='prestations_'.strtolower($ligneNomAssuPyscho->nomassurance);
								}
							}
							...
							<td>
								...
								?>	
								<input type="text" name="prixprestaPyscho[]" style="width:100px; text-align:center" id="prixprestaPyscho" class="prixprestaOrtho" value="<?php echo $lignePresta->prixpresta;?>"/>
							...
							<td>
								...
								?>	
								<input type="text" name="prixprestaPyscho[]" style="width:100px; text-align:center" id="prixprestaPyscho" class="prixprestaPyscho" value="<?php echo $lignePresta->prixpresta;?>"/>
		...
		<?php
			...
			?>		
				<table class="tablesorter tablesorter2" cellspacing="0" style="background:#fff; width:70%; margin-top:10px;"> 
					<thead> 
						<tr>
							<th style="width:60%"><?php echo getString(98);?></th>
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td>		
								...
								?>							
								<input type="text" name="prixprestaInf[]" style="width:100px; text-align:center" id="prixprestaInf" class="prixprestaInf" value="<?php echo $lignePresta->prixpresta;?>"/>								
					...
					<tbody>
						...
						<tr style="text-align:center;<?php if($ligneMedLabo->examenfait==1){ echo 'background:rgba(0,100,255,0.5);';}?>">
							...
							<td>	
								...
								?>								
								<input type="text" name="prixprestaLab[]" style="width:100px; text-align:center" id="prixprestaLab"  class="prixprestaLab" value="<?php echo $lignePresta->prixpresta;?>"/>								
							...
							?>
								...
								<!-- <i class="fa fa-ban fa-1x fa-fw"></i> -->
							<?php
							}else{
							?>
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td>		
								...
								?>							
								<input type="text" name="prixprestaRad[]" style="width:100px; text-align:center" id="prixprestaRad"  class="prixprestaRad" value="<?php echo $lignePresta->prixpresta;?>"/>								
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td>
								<?php
									if ($lignePresta->prixpresta == 0 AND $lignePresta->statupresta == 1)
									{
										...
										echo "<label class='badge'>The price of this act is not sure!! Check price (New act or act doesn't exit in tarriff)</label>" ;
									}elseif ($lignePresta->prixpresta != 0 AND $lignePresta->statupresta == 2 AND $presta_assuConsom!="prestations_private") {
										echo "<label class='badge'>This acts is not covered by insurance!</label>" ;
									}
								?>									
								<input type="text" name="prixprestaConsom[]" style="width:100px;" id="prixprestaConsom"  class="prixprestaConsom"  value="<?php echo $lignePresta->prixpresta;?>"/>
							...
							<td>		
								...
								?>							
								<input type="text" name="prixprestaConsom[]" style="width:100px; text-align:center" id="prixprestaConsom"  class="prixprestaConsom"  value="<?php echo $lignePresta->prixpresta;?>"/>								
					...
					<tr style="text-align:center;">
						<td>
							...
							<td>		
								<?php
									if ($lignePresta->prixpresta == 0 AND $lignePresta->statupresta == 1)
									{
										...
										echo "<label class='badge'>The price of this act is not sure!! Check price (New act or act doesn't exit in tarriff)</label>" ;
									}elseif ($lignePresta->prixpresta != 0 AND $lignePresta->statupresta == 2 AND $presta_assuMedoc!="prestations_private") {
										echo "<label class='badge'>This acts is not covered by insurance!</label>" ;
									}
								?>							
								<input type="text" name="prixprestaMedoc[]" style="width:100px;" id="prixprestaMedoc"  class="prixprestaMedoc"  value="<?php echo $lignePresta->prixpresta;?>"/>
							...
							<td>
								...
								?>									
								<input type="text" name="prixprestaMedoc[]" style="width:100px; text-align:center" id="prixprestaMedoc" class="prixprestaMedoc" value="<?php echo $lignePresta->prixpresta;?>"/>
			...
			<tr>
				...
				<?php 	
					...
					if(isset($_POST['searchbtn']) or isset($_POST['step1']) or isset($_GET['delete']))
					{
						...
						$resultTempFacture=$connexion->query("SELECT * FROM temp_facture tf, patients p WHERE p.numero='$numPa' AND tf.date_tempfacture='$datefacture' AND p.numero= tf.numero ORDER BY tf.id_tempfacture DESC");
					...
					?>			
							...
							?>
									<tr align="center">
										...
										<td>
									<?php 
										$resultcashier=$connexion->query('SELECT *FROM cashiernateurs c, utilisateurs u WHERE c.id_u=u.id_u') ;
...
<?php
		...
		$resultatsTempFact=$connexion->query("SELECT * FROM temp_facture tf, patients p WHERE p.numero='$numPa' AND tf.date_tempfacture>='$datedebut' AND tf.date_tempfacture<='$datefin' AND p.numero= tf.numero ORDER BY tf.id_tempfacture DESC") ;
		...
		if($comptResultTempFact!=0)
		{
			...
			while($ligne=$resultatsTempFact->fetch())//on r?up?e la liste des ??ents
			{
				...
				$resultPresta=$connexion->query('SELECT *FROM prestations WHERE id_prestation='.$ligne->id_prestation.'') ;
