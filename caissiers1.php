    ...
    if(!isset($_GET['divCash']))
    {
        ...
        <table class="tablesorter" cellspacing="0">
            ...
            try
            {
                ...
                $resultats=$connexion->query('SELECT *FROM utilisateurs u, cashiers c WHERE u.id_u=c.id_u AND (c.codecashier LIKE \'CNGC%\' OR c.codecashier LIKE \'CNGR%\') ORDER BY u.nom_u LIMIT '.$limit_start.', '.$pagination.'') or die( print_r($connexion->errorInfo()));
        ...
        <tr>
            <td>
                ...
                $nb_total=$connexion->query('SELECT COUNT(*) AS nb_total FROM utilisateurs u, cashiers c WHERE u.id_u=c.id_u AND (c.codecashier LIKE \'CNGC%\' OR c.codecashier LIKE \'CNGR%\') ORDER BY u.nom_u ');
