...
if($connect==true AND ($comptidM!=0 OR $comptidD!=0 OR $comptidC!=0))
{
	if($status==1)
	{
?>
...
<div class="account-container" style="width:90%; text-align:center;">
	...
	<?php 
	if(!isset($_GET['num']) AND !isset($_GET['cash']) AND !isset($_GET['med']) AND !isset($_GET['gnlmed']) AND !isset($_GET['gnlcashier']) AND !isset($_GET['inf']) AND !isset($_GET['lab']) AND !isset($_GET['rec']))
	{
								...
								<tr style="text-align:center;">							
									...
									<td>
										<table class="tablesorter" >
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td><a href="patients_laboreport.php?report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&laboreport=ok" class="btn">General Report</a></td>
													<!--
									...
									<td style="text-align:center;">
										<table class="tablesorter">
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td><a href="consom_report.php?report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&consomreport=ok" class="btn">Matériels</a></td>
												
													
													<td><a href="medoc_report.php?report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&medocreport=ok" class="btn">Médicaments</a></td>
									...
									<td style="text-align:center;display:inline;">
										<table class="tablesorter" style="width:50%;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td style="text-align:center;">
														<a href="patients1.php?reporthospPatient=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">Individual Report</a>
													</td>
													<td>
								...
								<tr style="text-align:center;">
									<td>
										<table class="tablesorter">
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td><a href="caissiers1.php?reporthospCash=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">Report</a></td>
													<!--
	...
	?>
        ...
        if(!isset($_GET['reporthospCash']))
        {
            ...
            if(isset($_POST['searchdailybillPerso']))
            {
                if(isset($_POST['dailydatebillPerso']))
                {
                    $dailydateperso = 'AND dateSortie LIKE \''.$_POST['dailydatebillGnl'].'%\' AND statusPaHosp=0';
...
<?php
		...
		<?php
			...
			<div id="dmacBillReport" style="display:inline;">
				...
				$resultConsult=$connexion->query('SELECT *FROM consultations c WHERE c.done=1 '.$dailydateperso.' ORDER BY c.dateconsu ASC');		
				/*$resultConsult->execute(array(
				'med'=>$_GET['med']
				));*/
				...
				<table style="width:100%;">
					...
					<a href="doctor_report.php?gnlmed=ok&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoBillReport=ok&createRN=1" style="text-align:left" id="dmacbillingpersopreview">
				...
				<thead> 
					<tr style="text-align:left">
						...
						<th style="width:15%">Full Patient name</th>
						<th style="width:20%" colspan=2><?php echo getString(113);?></th>
						<th style="width:10%"><?php echo getString(39);?></th>
						<th style="width:10%"><?php echo getString(98);?></th>
						<th style="width:10%"><?php echo getString(99);?></th>
					...
					<tr>
						...
						<td>
							<?php
								...
								{
									$fullnamePa = $ligneDoct->nom_u.' '.$ligneDoct->prenom_u;
						...
						<td>
						<?php
						$resultMedInf=$connexion->prepare('SELECT *FROM med_inf mi WHERE mi.id_consuInf=:idMedInf ORDER BY mi.id_medinf');		
						$resultMedInf->execute(array(
						'idMedInf'=>$ligneConsult->id_consu
						));
						...
						$resultMedRadio=$connexion->prepare('SELECT *FROM med_radio mr WHERE mr.id_consuRadio=:idMedRadio ORDER BY mr.id_medradio DESC');
						$resultMedRadio->execute(array(
						'idMedRadio'=>$ligneConsult->id_consu
						));
		...
		<table cellpadding=3 style="background:#fff; border:1px solid #eee; border-radius:4px; margin:auto auto 10px auto; padding: 10px; width:80%;">
			...
			<tr>
				...
				<td>
					...
					<button id="gnlCashierHospitalReport" class="btn-large">Hospital Report</button>
					</a>
