...
if(isset($_GET['deleteMoreMedLabo']))
{
	...
	echo '<script type="text/javascript">document.location.href="moreresultatsEditExam.php?labo='.$_GET['labo'].'&num='.$_GET['num'].'&idmedLab='.$_GET['idmedLab'].'&idmed='.$_GET['idmed'].'&dateconsu='.$_GET['dateconsu'].'&presta='.$_GET['presta'].'&idassu='.$_GET['idassu'].'&previewprint=ok'.$langue.''.$updateidmoremedLabo.'";</script>';
...
/* 
		...
		<table style="margin:20px auto;">
			<tr>
				...
				{
				?>
					<a style="padding:10px 40px;" href="<?php echo 'moreresultatsEditExam.php?labo='.$_SESSION['id'].'&num='.$_GET['num'].'&idmedLab='.$_GET['idmedLab'].'&idmed='.$_GET['idmed'].'&dateconsu='.$_GET['dateconsu'].'&presta='.$_GET['presta'].'&idassu='.$_GET['idassu'].'&previewprint=ok'?><?php if(isset($_GET['updateidmoremedLabo'])){ echo '&updateidmoremedLabo=ok';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn-large-inversed" name="showpreviewbtn" id="showpreviewbtn"><?php echo 'Finish'; ?></a>
				<?php
				}else{
					if(isset($_GET['previewprint']))
					{
				?>
					<a style="padding:10px 40px;" href="<?php echo 'moreresultatsEditExam.php?labo='.$_SESSION['id'].'&num='.$_GET['num'].'&idmedLab='.$_GET['idmedLab'].'&idmed='.$_GET['idmed'].'&dateconsu='.$_GET['dateconsu'].'&presta='.$_GET['presta'].'&idassu='.$_GET['idassu'].'&back=ok'?><?php if(isset($_GET['updateidmoremedLabo'])){ echo '&updateidmoremedLabo=ok';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn-large-inversed" name="showbackbtn" id="showbackbtn"><?php echo getString(221) ?></a>
				<?php
					}
				}
				?>
	...
	?>
		...
		?>
			...
			<form method="post" action="traitement_moreresultatsEditExam.php?num=<?php echo $_GET['num'];?>&labo=<?php echo $_SESSION['id'];?>&idmedLab=<?php echo $_GET['idmedLab'];?>&idmed=<?php echo $_GET['idmed'];?>&dateconsu=<?php echo $_GET['dateconsu'];?>&presta=<?php echo $_GET['presta'];?>&idassu=<?php echo $_GET['idassu'];?><?php if(isset($_GET['updateidmoremedLabo'])){ echo '&updateidmoremedLabo=ok';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" enctype="multipart/form-data">
...
$comptAssuConsu=$connexion->query('SELECT *FROM assurances a ORDER BY a.id_assurance');
							...
							<td>
								<a href="moreresultatsEditExam.php?deleteMoreMedLabo=<?php echo $ligneMoreMedLabo->id_moremedlabo;?>&labo=<?php echo $_GET['labo'];?>&num=<?php echo $_GET['num'];?>&idmedLab=<?php echo $_GET['idmedLab'];?>&idmed=<?php echo $_GET['idmed'];?>&dateconsu=<?php echo $_GET['dateconsu'];?>&presta=<?php echo $_GET['presta'];?>&idassu=<?php echo $_GET['idassu'];?>&previewprint=ok<?php if(isset($_GET['updateidmoremedLabo'])){ echo '&updateidmoremedLabo=ok';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn"><i class="fa fa-trash fa-1x fa-fw"></i></a>
