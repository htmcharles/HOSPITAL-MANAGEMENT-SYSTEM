						...
						<table style="margin:30px auto auto; width:70%; padding-left:80px;" cellpadding=3>
							...
							<tr>						
								<td style="text-align:left;color:black;">
									<input type="text" name="poids" id="poids"  value="<?php echo $poidsPa;?>" <?php if(isset($_GET['num']) and $comptidI!=0){echo "readonly='readonly'";}?> style="width:35px;"/><span style="line-height:37px;">Kg</span>
									
								</td>
								
								<td style="text-align:left;color:black;">
									<input type="text" name="taille" id="taille"  value="<?php echo $taillePa;?>" <?php if(isset($_GET['num']) and $comptidI!=0){echo "readonly='readonly'";}?> style="width:35px;"/><span style="line-height:37px;">Cm</span>
									
								</td>
													
								<td style="text-align:left;color:black;">
									<input type="text" name="tempera" id="tempera"  value="<?php echo $temperaPa;?>" <?php  if(isset($_GET['num']) and $comptidI!=0){ echo 'readonly="readonly"';}else{echo '';}?> style="width:35px;"/><span style="line-height:37px;">°C</span>
								</td>

								<td style="text-align:left;color:black;">
									<input type="text" name="oxgen" id="oxgen"  value="<?php echo $oxgenPa;?>" <?php  if(isset($_GET['num']) and $comptidI!=0){ echo 'readonly="readonly"';}else{echo '';}?> style="width:35px;"/><span style="line-height:37px;">O2</span>
								</td>
								
								<td style="text-align:left;color:black;">
									<input type="text" name="tensionart" id="tensionart" value="<?php echo $tensionartPa;?>" <?php  if(isset($_GET['num']) and $comptidI!=0){ echo 'readonly="readonly"';}else{echo '';}?> style="width:35px;"/><span style="line-height:37px;">mmHg</span>
									
								</td>
								
								<td style="text-align:left;color:black;">
									<input type="text" name="pouls" id="pouls" value="<?php echo $poulsPa;?>" <?php  if(isset($_GET['num']) and $comptidI!=0){ echo 'readonly="readonly"';}else{echo '';}?> style="width:35px;"/><span style="line-height:37px;">/min</span>
			...
			<table class="cons-table" style="padding: 5px; margin: 20px auto; background: #ddd none repeat scroll 0px 0px; border: 1px solid rgb(238, 238, 238); border-radius: 4px; width:85%;"  cellpadding=5>			
							...
							<table class="tablesorter" cellspacing="0"> 
								...
								?>
									...
									for($i=1;$i<=$assuCount;$i++)
									{
										...
										{
											$presta_assuRad='prestations_'.$ligneNomAssuLab->nomassurance;
										}
									}
				...
				<tr>	
					...
					<td>
						...
						$resultatsPrestaSoins=$connexion->query('SELECT *FROM '.$presta_assu.' p, categopresta_ins cp WHERE cp.id_categopresta=p.id_categopresta AND p.id_categopresta=25 ORDER BY p.nompresta ASC');
