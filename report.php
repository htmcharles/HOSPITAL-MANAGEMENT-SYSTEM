...
<div class="account-container" style="width:90%; text-align:center;">
	...
	?>
		<ul>
			...
			?>
				...
				<?php if($lignecount!=0){?>
				<li style="width:33.33%;"><a onclick="ShowList('Msg')" style="margin-left:5px;" data-title="<?php echo getString(49);?> || Unread messages: <?php echo $lignecount; ?>"><i class="fa fa-envelope fa-lg fa-fw"></i> <?php echo getString(49);?> <i class="badge flashing"><?php echo $lignecount; ?></i> </a></li>
		        <?php }else{?>
	...
	{
	?>
		<a href="report.php?Report=ok&StockChoose=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn-large-inversed" name="reportsbtn" style="font-size:20px;height:40px; padding:10px 40px;margin-right:10px;">
			<?php echo 'Reports';?>
		</a>
		...
		<a href="closing_stock.php?<?php if(isset($_GET['english'])){ echo 'english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo 'francais='.$_GET['francais'];}}?>" class="btn-large-inversed" name="reportsbtn" style="font-size:20px;height:40px; padding:10px 40px;margin-right:10px;font-family:calibri;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td style="text-align:center;">
														<a href="printPatients.php?coordi=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&patientList=ok" class="btn">Phone Report</a>
													</td>
													<td>
														<a href="report.php?gnlreport=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">General Report</a>
													</td>
												</tr>
											</tbody>
										</table>
										...
										<table class="tablesorter"  style="width:25%;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													...
													<td><a href="report.php?gnlmed=ok&report=ok" class="btn">General Report</a></td>
													<td><a href="global.php?global=ok&report=ok" class="btn">Global Health</a></td>
												</tr>
											</tbody>
										</table>
									</td>
										...
										<table class="tablesorter"  style="width:25%;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													...
													<td><a href="report.php?othersacte=ok&report=ok" class="btn">Report</a></td>
										...
										<table class="tablesorter"  style="width:25%;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													<!-- <td><a href="medecins1.php?report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">Report</a></td>
													 -->
													<td><a href="report.php?coordi=<?php if(isset($_GET['coordi'])){ echo $_GET['coordi'];}?>&codeI&francais=francais" class="btn">General Report</a></td>
								...
								<td>
										...
										<table class="tablesorter"  style="width:80%;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													...
													<td><a href="report.php?gnlcashier=ok&report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">General Report</a></td>

													<td><a href="report.php?Generalunbill=ok&report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">General UnBilled Report</a></td>
												</tr>
											</tbody>
										</table>
									</td>
									...
									<td>
										<table class="tablesorter" >
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td><a href="patients_laboreport.php?report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&chooseReport=ok" class="btn">Report</a></td>
													<td><a href="report.php?Covid19report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&chooseReport=ok" class="btn">Report</a></td>
												</tr>
											</tbody>
										</table>
									</td>
										...
										<table class="tablesorter">
											...
											<tbody>
												<tr> 
													...
													?>
														<td>
															<a href="insurance_report.php?nomassu=<?php echo $ligne->nomassurance;?>&insugnlreport=ok&idassu=<?php echo $ligne->id_assurance;?>" id="insurance" class="btn"><?php echo $ligne->nomassurance;?></a>
														</td>
													<?php
													}
													?>
									...
									<td colspan=4>
										<table class="tablesorter">
											...
											<tbody>
												<tr>
													<td>
														<a href="insurancesummaryreport.php" class="btn">Insurance Summary Report</a>
													</td>

													<td>
														<a href="Insurancesummaryreport.php" class="btn">Doctor Summary Report</a>
													</td>
												</tr>
											</tbody>
										</table>
										...
										<table class="tablesorter" style="width:50%;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													...
													<td>
														<a href="report.php?gnlreporthosp=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">General Report</a>
													</td>
												</tr>
											</tbody>
										</table>
	...
	?>
		...
		<h3>UnBilled Bill</h3>
		<hr>
			<form action="report.php?audit=<?php echo $_SESSION['id'];?>&cashier=<?php echo $cashier; ?>&id_u=<?php echo $id_u; ?>&UnBilled=ok&dmacbillgnl=ok&selectGnlBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
	...
	?>
            ...
            <table cellpadding=3 style="margin:auto auto 10px auto; padding: 10px; width:95%;">
                <tr>
                    <td style="font-size:18px; text-align:center; width:33.333%;">
                        <a href="report.php?cash=<?php echo $_GET['cash'];?>&coordi=<?php echo $_SESSION['id'];?>&report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="text-align:center;<?php if(isset($_GET['report'])){ echo 'display:none;';}else{ echo 'display:inline;';}?>">
                            <button id="gnlMedicReport" class="btn-large">Clinic Report</button>
                        </a>

                        <a href="report.php?cash=<?php echo $_GET['cash'];?>&coordi=<?php echo $_SESSION['id'];?>&reporthospCash=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="text-align:center;<?php if(isset($_GET['reporthospCash'])){ echo 'display:none;';}else{ echo 'display:inline;';}?>">
			...
			<form action="report.php?cash=<?php echo $_GET['cash'];?>&audit=<?php echo $_SESSION['id'];?><?php if(isset($_GET['reporthospCash'])){ echo '&reporthospCash='.$_GET['reporthospCash'];}else{ if(isset($_GET['report'])){ echo '&report='.$_GET['report'];}}?>&dmacbillperso=ok&selectPersoBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmacbillperso" style="margin:auto auto 20px">
					<tr style="display:inline-block; margin-bottom:25px;">
						...
						<?php if(!isset($_SESSION['codeR']) OR !isset($_SESSION['codeCash'])){
						?>
					...
					<tr style="visibility:visible">
						...
						<?php 
						$allInsu = $connexion->query("SELECT * FROM assurances"); 
						$allInsu->setFetchMode(PDO::FETCH_OBJ);

						?>
						<td style="text-align:left;display:none;" id="checkassu">
							<!-- <?php if(!isset($_SESSION['codeR']) OR !isset($_SESSION['codeCash'])){
							?>
								<input type="checkbox" name="tout" style="width: 7px;">
							<?php
							}?> -->
							
							<select name="checkassu" style="width:100px;height:40px;">
								<option value="all">All</option>
								<?php while($Feassu=$allInsu->fetch()){ ?>
									<option value="<?php echo $Feassu->nomassurance; ?>"><?php echo $Feassu->nomassurance; ?></option>
								<?php } ?>
							</select>
						</td>
					</tr>
        ...
        if(!isset($_GET['reporthospCash']))
        {
            if(isset($_GET['dmacbillperso']) OR isset($_GET['selectPersoBill']))
            {
				...
				if(isset($_POST['checkassu']) AND $_POST['checkassu']=="all")
					{
						if(!isset($_SESSION['codeR']) OR !isset($_SESSION['codeCash'])){
							/*if (isset($_POST['tout'])) {*/
								$checkassu = "";
							/*}else{
								$checkassu = "b.nomassurance != 'PRIVATE' AND ";
							}*/
						}else{
						...
						if(isset($_POST['checkassu']) AND $_POST['checkassu']!="all")
						{
							$checkassu = "b.nomassurance = '".$_POST['checkassu']." ' AND ";
						}
					}
                ...
                if(isset($_POST['searchdailybillPerso']))
                {
                    if(isset($_POST['dailydatebillPerso']))
                    {
                        $dailydateperso = ''.$checkassu.' (b.codecashier IN (\''.$cash.'\') AND b.datebill LIKE \''.$_POST['dailydatebillPerso'].'%\')';
                ...
                if(isset($_POST['searchmonthlybillPerso']))
                {
                    if(isset($_POST['monthlydatebillPerso']) AND isset($_POST['monthlydatebillPersoYear']))
                    {
                        ...
                        $dailydateperso = ''.$checkassu.' (b.codecashier IN (\''.$cash.'\') AND b.datebill>=\''.$umwaka.'-'.$ukwezi.'-01\' AND (b.datebill<\''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'\' OR b.datebill LIKE \''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'%\'))';
                ...
                if(isset($_POST['searchannualybillPerso']))
                {
                    if(isset($_POST['annualydatebillPerso']))
                    {
                        ...
                        $dailydateperso = ''.$checkassu.' (b.codecashier IN (\''.$cash.'\') AND b.datebill >=\''.$year.'-01-01\' AND b.datebill <=\''.$year.'-12-31\')';
                ...
                if(isset($_POST['searchcustombillPerso']))
                {
                    if(isset($_POST['customdatedebutbillPerso']) AND isset($_POST['customdatefinbillPerso']))
                    {
                        ...
                        $dailydateperso = ''.$checkassu.' (b.codecashier IN (\''.$cash.'\') AND b.datebill>=\''.$debut.'\' AND (b.datebill<\''.$fin.'\' OR b.datebill LIKE \''.$fin.'%\'))';
            ...
            <div id="dmacBillReport" style="display:inline">
                ...
                <?php
              // echo 'SELECT *FROM bills b, bills_other_cashier boc WHERE '.$dailydateperso.' ORDER BY b.datebill ASC';
...
*/
            ...
            if(isset($_POST['checkassu']) AND $_POST['checkassu']=="all")
			{
				if(!isset($_SESSION['codeR']) OR !isset($_SESSION['codeCash'])){
					/*if (isset($_POST['tout'])) {*/
						$checkassu = "";
					/*}else{
						$checkassu = " AND nomassuranceHosp != 'PRIVATE'";
					}*/
				}else{
				...
				if(isset($_POST['checkassu']) AND $_POST['checkassu']!="all")
				{
					$checkassu = " AND nomassuranceHosp = '".$_POST['checkassu']." '";
				}
			}
            ...
            if(isset($_POST['searchdailybillPerso']))
            {
                if(isset($_POST['dailydatebillPerso']))
                {
                    $dailydateperso = ''.$checkassu.' AND dateSortie LIKE \''.$_POST['dailydatebillPerso'].'%\' AND statusPaHosp=0';
            ...
            if(isset($_POST['searchmonthlybillPerso']))
            {
                if(isset($_POST['monthlydatebillPerso']) AND isset($_POST['monthlydatebillPersoYear']))
                {
                    ...
                    $dailydateperso = ''.$checkassu.' AND dateSortie>=\''.$umwaka.'-'.$ukwezi.'-01\' AND (dateSortie<\''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'\' OR dateSortie LIKE \''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'%\') AND statusPaHosp=0';
            ...
            if(isset($_POST['searchannualybillPerso']))
            {
                if(isset($_POST['annualydatebillPerso']))
                {
                    ...
                    $dailydateperso = ''.$checkassu.' AND dateSortie>=\''.$year.'-01-01\' AND dateSortie<=\''.$year.'-12-31\' AND statusPaHosp=0';
            ...
            if(isset($_POST['searchcustombillPerso']))
            {
                if(isset($_POST['customdatedebutbillPerso']) AND isset($_POST['customdatefinbillPerso']))
                {
                    ...
                    $dailydateperso = ''.$checkassu.' AND dateSortie>=\''.$debut.'\' AND (dateSortie<\''.$fin.'\' OR dateSortie LIKE \''.$fin.'%\') AND statusPaHosp=0';
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="text-align:left; width:33.333%;">
                                ...
                                <a href="cashier_report.php?cash=<?php echo $_GET['cash'];?>&dailydateperso=<?php echo $dailydateperso;?>&caVisit=<?php echo $caVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoBillReportHosp=ok&createRN=1" style="text-align:center" id="dmacbillpersopreview">
	...
	?>
		...
		<div id="selectdatePersoBillReport">
			...
			<form action="report.php?GenerelNurseReport=ok&codeI=<?php echo $_GET['codeI'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmacbillperso=ok&selectPersoBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?><?php if(isset($_GET['coordi'])){ echo'&coordi=ok';}?>" method="post" style="margin:auto;padding:5px;width:90%;">
								...
								<td>
									<?php
										...
										for ($i=1; $i <=$assuCount ; $i++) { 
											...
											$getAssuConsu->setFetchMode(PDO::FETCH_OBJ);
											if ($ligneNomAssu=$getAssuConsu->fetch()) {
												$prestations_assu = 'prestations_'.strtolower($ligneNomAssu->nomassurance);
											}
										}
							...
							<td style="text-align: center;font-weight: bold;">
								<?php
									...
									if($GetAssuname = $GetAssu->fetch()){
										...
										$presta_assu='prestations_'.strtolower($GetAssuname->nomassurance);
									}
								?>
							</td>
	...
	<?php
		if(isset($_GET['allnurse'])){?>
			...
			<h3>All Nurse</h3>
			<div id="selectdatePersoMedicReport">
			<form action="report.php?codeI=<?php echo $_GET['codeI'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&selectPersoMedic=ok&allnurse=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
		...
		?>
			...
			<a href="dmacreport.php?codeI=<?php echo $_GET['codeI'];?>&dailydateperso=<?php echo $dailydateperso;?>&paVisit=<?php echo $paVisit;?>&divPersoMedicReport=ok" style="text-align:left;" id="dmacmedicalpersopreview">
	...
	?>
		...
		if(isset($_GET['petitchirugie'])){?>
			...
			<div id="selectdatePersoMedicReport">
			<form action="report.php?codeI=<?php echo $_GET['codeI'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&selectPersoMedic=ok&petitchirugie=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
...
<!-- 						<th style="text-align: center;">Date consultation</th>
	...
	<?php
		if ((isset($_SESSION['codeAcc']) OR isset($_GET['codeAcc'])) AND !isset($_GET['cash'])) {
	?>
		<div>
	<?php
	...
	?>
			<tr style="text-align: center;">
				...
				<td>
					<a href="caissiers1.php?report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn-large" name="dettesListbtn" style="font-size:20px;height:40px; padding:10px 40px;margin-left: 10px;">
						<?php echo 'Cashier Reports';?>
					</a>
				</td>
	...
	?>
			...
			<tr style="text-align: center;">
				<td style="text-align: center;position: relative;left: 220px;">	
					<a href="report.php?code=<?php echo $_SESSION['id'];if(isset($_GET['coordi'])){ echo '&coordi='.$_GET['coordi'];}if(isset($_GET['report'])){ echo '&report='.$_GET['report'];}?><?php if(isset($_GET['clinic'])){ echo '&clinic='.$_GET['clinic'];}?>&clearbill=ok" style="text-align:center;<?php if(isset($_GET['clearbill'])){ echo 'display:none';}else{ echo 'display:inline';}?>">
					
					<button id="clearbillReport" class="btn-large">Billing Clinical Report</button>						
					</a>
				</td>
				<td style="text-align: center;position: relative;left:220px;">
					<a href="report.php?code=<?php echo $_SESSION['id'];if(isset($_GET['coordi'])){ echo '&coordi='.$_GET['coordi'];}if(isset($_GET['report'])){ echo '&report='.$_GET['report'];}?><?php if(isset($_GET['clinic'])){ echo '&clinic=ok';}?>&unbill=ok" style="text-align:center;<?php if(isset($_GET['unbill'])){ echo 'display:none';}else{ echo 'display:inline';}?>">
			...
			<tr style="text-align: center;">
				<td style="text-align: center;position: relative;left: 220px;">	
					<a href="report.php?code=<?php echo $_SESSION['id'];if(isset($_GET['coordi'])){ echo '&coordi='.$_GET['coordi'];}if(isset($_GET['report'])){ echo '&report='.$_GET['report'];}?><?php if(isset($_GET['hospi'])){ echo '&hospi='.$_GET['hospi'];}?>&clearbill=ok" style="text-align:center;<?php if(isset($_GET['clearbill'])){ echo 'display:none';}else{ echo 'display:inline';}?>">
		...
		?>
			<div id="selectclearbillReport" style="<?php if(isset($_GET['clearbill'])){ echo 'display:inline';}else{ echo 'display:none';}?>">
				...
				<form action="report.php?code=<?php echo $_SESSION['id'];?>&report=ok&resu=ok<?php if(isset($_GET['clinic'])){ echo '&clinic='.$_GET['clinic'];}?><?php if(isset($_GET['clearbill'])){ echo '&clearbill='.$_GET['clearbill'];}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
			...
			<?php
				...
				if(isset($_GET['clinic']) AND isset($_GET['clearbill']))
				{
					...
					if(isset($_POST['searchdailyPerso']))
					{
						if(isset($_POST['dailydatePerso']))
						{
							$dailydateperso = ' (b.datebill>=\''.$_POST['dailydatePerso'].' 00:00:00\' AND b.datebill<=\''.$_POST['dailydatePerso'].' 23:59:59\')';
					...
					if(isset($_POST['searchcustomPerso']))
					{
						if(isset($_POST['customdatedebutPerso']) AND isset($_POST['customdatefinPerso']))
						{
							...
							$dailydateperso = ' b.datebill>=\''.$debut.' 00:00:00\' AND b.datebill<=\''.$fin.' 23:59:59\'';
			...
			?>
				...
				<tr>
					<td style="text-align:left; width:33.333%;">
						...
						<!-- <a href="<?php if($nomassu=="RSSB"){ echo 'dmacrssb_report.php'; }else{ if($nomassu=="MMI"){ echo 'dmacmmi_report.php'; }else{ if($nomassu=="UAP" OR $nomassu=="BRITAM"){ echo 'dmacuap_report.php'; }else{ if($nomassu=="RADIANT" OR $nomassu=="CORAR" OR $nomassu=="SORAS"){ echo 'dmacradiant_report.php'; }else{ echo 'dmacinsurance_report.php';}}}}?>?dailydategnl=<?php echo $dailydategnl;?>&divGnlBillReport=ok&gnlpatient=ok&paVisitgnl=<?php echo $paVisitgnl;?>&stringResult=<?php echo $stringResult;?>&percent=<?php echo $percent;?>&nomassu=<?php echo $nomassu;?>&idassu=<?php echo $idassu;?>&createRN=1" style="text-align:center" id="dmacbillgnlpreview"> -->
						<a href="<?php if($assura==5){ echo 'accountrssb_report.php'; }else{ if($assura==11){ echo 'accountmmi_report.php'; }else{ if($assura==4 OR $assura==21){ echo 'accountuap_report.php'; }else{ if($assura==8 OR $assura==18 OR $assura==26){ echo 'accountradiant_report.php'; }else{ echo 'accountinsurance_report.php';}}}}?>?audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok<?php if(isset($_GET['clinicAssuRepo'])){echo'&clinicAssuRepo=ok';} ?><?php if(isset($_GET['gnlMedAssuReport'])){echo'&gnlMedAssuReport=ok';} ?>&divGnlBillReport=ok&gnlpatient=ok&selectPersoMedicAssu=ok&dailydategnl=<?php echo $dailydategnl; ?>&stringResult=<?php echo $stringResult; ?>&paVisitgnl=<?php echo $paVisitgnl;?>&percent=<?php echo $percent;?>&nomassu=<?php echo $nomassu;?>&idassu=<?php echo $assura;?>&createRN=1<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>">
		...
		if (isset($_GET['hospiAssuRepoCode'])) {
			...
			<form action="report.php?code=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&report=ok&hospi=ok&unclearbill=ok<?php if(isset($_GET['hospiAssuRepoCode'])){echo'&hospiAssuRepoCode=ok';} ?><?php if(isset($_GET['gnlMedAssuReport'])){echo'&gnlMedAssuReport=ok';} ?>&selectPersoMedicAssu=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
	...
	<?php
		if (isset($_GET['Generalunbill'])) {
	?>
			<div id="selectunclearbillReport">
			<h2>General Unbilled Bill Report</h2>
						
				<form action="report.php?code=<?php echo $_SESSION['id'];?>&report=ok&resu=ok&Generalunbill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
					...
					<table style="width:100%;">
						<tr>
							<td style="text-align:left; width:33.333%;">
								...
								<a href="accountsUnbilledReport.php?clinic=ok&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divGnlUnbilledReport=ok&createRN=1&UnBilledbill=ok" style="text-align:left" id="dmacmedicalpersopreview">
	...
	?>
		...
		?>
				<div id="selectdatePersoMedicReport" style="<?php if(isset($_GET['gnlMedMedicReport']) OR isset($_SESSION['codeM'])){ echo 'display:inline';}else{ echo 'display:none';}?>">
					...
					<form action="report.php?med=<?php echo $_GET['med'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok<?php if(isset($_GET['clinic'])){ echo '&clinic='.$_GET['clinic'];}?>&gnlMedMedicReport&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
					...
					<table style="width:100%;">
						<tr>
							<td style="text-align:left; width:33.333%;">
								...
								<a href="doctor_report.php?med=<?php echo $_GET['med'];?><?php if(isset($_GET['clinic'])){ echo '&clinic='.$_GET['clinic'];}?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&createRN=1" style="text-align:left" id="dmacmedicalpersopreview">
				...
				<?php
					...
					<div id="dmacBillReport" style="display:inline;">
						...
						<table style="width:100%;">
							...
							<a href="doctor_report.php?med=<?php echo $_GET['med'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?><?php if(isset($_GET['clinic'])){ echo '&clinic='.$_GET['clinic'];}?>&stringResult=<?php echo $stringResult;?>&divPersoBillReport=ok&createRN=1" style="text-align:left" id="dmacbillingpersopreview">
					...
					<table style="width:100%;">
						<tr>
							<td style="text-align:left; width:33.333%;">
								...
								<a href="doctor_report.php?med=<?php echo $_GET['med'];?><?php if(isset($_GET['hospi'])){ echo '&hospi='.$_GET['hospi'];}?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&createRN=1" style="text-align:left" id="dmacmedicalpersopreview">
				...
				<?php
					...
					<div id="dmacBillReport" style="display:inline;">
						...
						<table style="width:100%;">
							...
							<a href="doctor_report.php?med=<?php echo $_GET['med'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?><?php if(isset($_GET['hospi'])){ echo '&hospi='.$_GET['hospi'];}?>&stringResult=<?php echo $stringResult;?>&divPersoBillReport=ok&createRN=1" style="text-align:left" id="dmacbillingpersopreview">
...
<?php
		...
		<?php
			...
			<div id="dmacBillReport" style="display:inline;">
				...
				<table style="width:100%;">
					...
					<a href="doctor_report.php?gnlmed=<?php echo $_GET['gnlmed'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoBillReport=ok&createRN=1" style="text-align:left" id="dmacbillingpersopreview">
	...
	?>
		...
		<div id="selectdatePersoMedicReport" style="<?php if(isset($_GET['gnlMedMedicReport']) OR isset($_SESSION['codeM'])){ echo 'display:inline';}else{ echo 'display:none';}?>">
			...
			<form action="report.php?othersacte=<?php echo $_GET['othersacte'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&gnlMedMedicReport&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
		...
		<div id="selectdatePersoBillReport" style="<?php if(isset($_GET['gnlMedBillReport'])){ echo 'display:inline';}else{ echo 'display:none';}?>">
			...
			<form action="report.php?othersacte=<?php echo $_GET['othersacte'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&gnlMedBillReport&selectPersoBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
...
<?php
			...
			<table style="width:100%;">
				<tr>
					...
					<td style="text-align:left; width:33.333%;">
						...
						<a href="other_report.php?othersacte=<?php echo $_GET['othersacte'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&createRN=1" style="text-align:left" id="dmacmedicalpersopreview">
		...
		<?php
			...
			<div id="dmacBillReport" style="display:inline;">
				...
				<table style="width:100%;">
					...
					<a href="other_report.php?othersacte=<?php echo $_GET['othersacte'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoBillReport=ok&createRN=1" style="text-align:left" id="dmacbillingpersopreview">
					...
					<table style="width:100%;">
						<tr>
							<td style="text-align:left; width:33.333%;">
								...
								<a href="other_report.php?med=<?php echo $_GET['med'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&createRN=1" style="text-align:left" id="dmacmedicalpersopreview">
	...
	?>
		...
		<div id="selectdatePersoMedicReport" style="<?php if(isset($_GET['gnlCashierClinicReport']) OR isset($_SESSION['codeM'])){ echo 'display:inline';}else{ echo 'display:none';}?>">
			...
			<form action="report.php?gnlcashier=<?php echo $_GET['gnlcashier'];?>&audit=<?php echo $_SESSION['id'];?>&reportCash=ok&dmac=ok&gnlCashierClinicReport=ok&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmac" style="margin:auto auto 20px">
					...
					<tr id="dmacligne" style="visibility:visible">
						...
						<td style="text-align:left;display:none;" id="checkassu">
							<select name="checkassu" style="width:100px;height:40px;">
								<option value="all">All</option>
								<option value="AssuOnly">Insuranses Only</option>
								<?php while($Feassu=$allInsu->fetch()){ ?>
									<option value="<?php echo $Feassu->nomassurance; ?>"><?php echo $Feassu->nomassurance; ?></option>
								<?php } ?>
							</select>
		...
		<div id="selectdatePersoBillReport" style="<?php if(isset($_GET['gnlCashierHospitalReport'])){ echo 'display:inline';}else{ echo 'display:none';}?>">
			...
			<form action="report.php?gnlcashier=<?php echo $_GET['gnlcashier'];?>&audit=<?php echo $_SESSION['id'];?>&reporthospCash=ok&dmac=ok&gnlCashierHospitalReport=ok&selectPersoBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmac" style="margin:auto auto 20px">
					...
					<tr id="dmacligne" style="visibility:visible">
						...
						<td style="text-align:left;display:none;" id="checkassu2">
							<!-- <select name="checkassu" style="width:100px;height:40px;">
								<option value="all">All</option>
								<option value="private">PRIVATE</option>
								<option value="noprivate">Insurance</option>
							</select> -->
							<!-- <input type="checkbox" name="checkassu" style="width: 7px;" /> -->
						</td>
					</tr>
		...
		if(isset($_GET['dmac']) AND isset($_GET['selectPersoMedic']))
		{
			...
			// 	$checkassu = "";
			// }else{
			// 	if(isset($_POST['checkassu']) AND $_POST['checkassu']=="noprivate")
			// 	{
			// 		$checkassu = "b.nomassurance != 'PRIVATE ' AND ";
			// 	}else{
			// 		if(isset($_POST['checkassu']) AND $_POST['checkassu']=="private")
			// 		{
			// 			$checkassu = "b.nomassurance = 'PRIVATE ' AND ";
			// 		}
			// 	}
			...
			if (isset($_POST['checkassu'])) {
				if($_POST['checkassu']=="all"){
					$checkassu = "";
				}else{
					if($_POST['checkassu']=="AssuOnly"){
						$checkassu = "b.nomassurance != 'PRIVATE ' AND ";
					}else{
						$checkassu = "b.nomassurance='".$_POST['checkassu']."' AND ";
					}
			...
			if(isset($_POST['searchdailyPerso']))
			{
				if(isset($_POST['dailydatePerso']))
				{
					$dailydateperso = ''.$checkassu.'b.datebill LIKE \''.$_POST['dailydatePerso'].'%\'';
			...
			if(isset($_POST['searchmonthlyPerso']))
			{
				if(isset($_POST['monthlydatePerso']) AND isset($_POST['monthlydatePersoYear']))
				{
                    ...
                    $dailydateperso = ''.$checkassu.'b.datebill>=\''.$umwaka.'-'.$ukwezi.'-01\' AND (b.datebill<\''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'\' OR b.datebill LIKE \''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'%\')';
			...
			if(isset($_POST['searchannualyPerso']))
			{
				if(isset($_POST['annualydatePerso']))
				{
                    ...
                    $dailydateperso = ''.$checkassu.'b.datebill >=\''.$year.'-01-01\' AND b.datebill <=\''.$year.'-12-31\'';
			...
			if(isset($_POST['searchcustomPerso']))
			{
				if(isset($_POST['customdatedebutPerso']) AND isset($_POST['customdatefinPerso']))
				{
                    ...
                    $dailydateperso = ''.$checkassu.'b.datebill>=\''.$debut.'\' AND (b.datebill<\''.$fin.'\' OR b.datebill LIKE \''.$fin.'%\')';
		...
		<div id="dmacMedicReport" style="display:inline;">
			...
			<?php
	           ...
	           /* $resultCashierBillReport->execute(array(
	            ...
	            //echo 'SELECT *FROM bills WHERE '.$dailydateperso.' ORDER BY b.datebill ASC';
			...
			<table style="width:100%;">
				<tr>
					<td style="text-align:left; width:33.333%;">
						...
						<a href="cashier_report.php?gnlcashier=<?php echo $_GET['gnlcashier'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoBillReport=ok&createRN=1&caVisit=<?php echo $caVisit?>" style="text-align:left" id="dmacmedicalpersopreview">
							
							<button style="width:250px; margin:auto;" type="submit" name="printMedicReportPerso" id="printMedicReportPerso" class="btn-large">
								<i class="fa fa-desktop fa-lg fa-fw"></i> Preview print <i class="badge"><?php echo $compCashBillReport; ?></i>
							</button>
		...
		<?php
			...
			if(isset($_GET['dmac']) AND isset($_GET['selectPersoBill']))
			{
				...
				// 	if(isset($_POST['checkassu']) AND $_POST['checkassu']=="noprivate")
				// 	{
				// 		$checkassu = "nomassuranceHosp != 'PRIVATE ' AND ";
				// 	}else{
				// 		if(isset($_POST['checkassu']) AND $_POST['checkassu']=="private")
				// 		{
				// 			$checkassu = "nomassuranceHosp = 'PRIVATE ' AND ";
				...
				if(isset($_POST['searchdailyPerso']))
				{
					if(isset($_POST['dailydatePerso']))
					{
						$dailydateperso = ''.$checkassu.'dateSortie LIKE \''.$_POST['dailydatePerso'].'%\' AND statusPaHosp=0';
				...
				if(isset($_POST['searchmonthlyPerso']))
				{
					if(isset($_POST['monthlydatePerso']) AND isset($_POST['monthlydatePersoYear']))
					{
	                    ...
	                    $dailydateperso = ''.$checkassu.'dateSortie>=\''.$umwaka.'-'.$ukwezi.'-01\' AND (dateSortie<\''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'\' OR dateSortie LIKE \''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'%\') AND statusPaHosp=0';
				...
				if(isset($_POST['searchannualyPerso']))
				{
					if(isset($_POST['annualydatePerso']))
					{
	                    ...
	                    $dailydateperso = ''.$checkassu.'dateSortie>=\''.$year.'-01-01\' AND dateSortie<=\''.$year.'-12-31\' AND statusPaHosp=0';
				...
				if(isset($_POST['searchcustomPerso']))
				{
					if(isset($_POST['customdatedebutPerso']) AND isset($_POST['customdatefinPerso']))
					{
	                    ...
	                    $dailydateperso = ''.$checkassu.'dateSortie>=\''.$debut.'\' AND (dateSortie<\''.$fin.'\' OR dateSortie LIKE \''.$fin.'%\') AND statusPaHosp=0';
			...
			<div id="dmacBillReport" style="display:inline;">
				...
				$resultConsult=$connexion->query('SELECT *FROM patients_hosp  WHERE '.$dailydateperso.' ORDER BY dateSortie ASC');		
				/*$resultConsult->execute(array(
				'med'=>$_GET['med']
				));*/
				...
				<table style="width:100%;">
					...
					<a href="cashier_report.php?gnlcashier=ok&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoBillReportHosp=ok&createRN=1&caVisit=<?php echo $caVisit?>" style="text-align:left" id="dmacbillingpersopreview">
						
						<button style="width:250px; margin:auto;" type="submit" name="printBillReportPerso" id="printBillReportPerso" class="btn-large-inversed">
							<i class="fa fa-desktop fa-lg fa-fw"></i> Preview print <i class="badge"><?php echo $comptConsult; ?></i>
						</button>
...
<?php
	...
	<?php if(isset($_GET['CallCurrentStoModal'])){ ?>
        <div>
        	<a href="Currentstock.php?currentStockNow=ok&currentStockNowAll=ok" class="btn"><i class="fa fa-check-circle"></i> All</a>

            <a href="Currentstock.php?currentStockNow=ok&currentStockNowDrugs=ok" class="btn"><i class="fa fa-check-circle"></i> Drugs</a>

            <a href="Currentstock.php?currentStockNow=ok&currentStockNowConsu=ok" class="btn"><i class="fa fa-check-circle"></i> Consummables</a>

            <a href="Currentstock.php?currentStockNow=ok&currentStockNowMat=ok" class="btn"><i class="fa fa-check-circle"></i> Materials</a>
        </div>
    <?php }?>
	...
	?>
				...
				<button onclick="window.location.href='report.php?StockChoose=ok&MedicamentReport=ok';" class="btn-large">Medicament</button>
				<button onclick="window.location.href='report.php?StockChoose=ok&ConsumablesReport=ok';" class="btn-large-inversed">Consomables</button>
				<button onclick="window.location.href='report.php?StockChoose=ok&MaterialsReport=ok';" class="btn-large">Materials</button>
				
				<br><br>
				<button onclick="window.location.href='report.php?CallCurrentStoModal=ok';" class="btn-large">Current Stock Now</button>
				<button onclick="window.location.href='report.php?Covid19report=ok&Report=ok';" class="btn-large-inversed">COVID - 19</button>
				<button onclick="window.location.href='patients_laboreport.php?chooseReports=ok';" class="btn-large-inversed">Laboratory other tests</button>

		
		<?php if (isset($_GET['MedicamentReport']) || isset($_GET['ConsumablesReport']) || isset($_GET['MaterialsReport']) ){
		 ?>
				<br><br>
					<hr>
					<h3 style="padding: 10px 10px;background: #ddd;border-radius: 7px;box-shadow: 0 0 3px #B20000;"><?php if(isset($_GET['MedicamentReport'])){echo "Drugs Reports";}else{if(isset($_GET['ConsumablesReport'])){echo "Consumables Reports";}else{if(isset($_GET['MaterialsReport'])){echo "Materials Report";}}} ?></h3>
					<hr>
					<a href="report.php?StockChoose=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&stockInrepo=ok" class="btn"><i class="fa fa-arrow-circle-up"></i> Stok In</a>
					<a href="report.php?StockChoose=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&stockOutrepo=ok" class="btn"><i class="fa fa-arrow-circle-down"></i> Stok Out</a>

					<a href="report.php?StockChoose=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&ExpiredDrugs=ok"  <?php if($countD != 0){echo'class="btn flashing"';}else{echo'class="btn"';} ?>><i class="fa fa-warning" style="color: black;"></i> <span style="padding: 2px 7px;color:white;font-weight:bold;background: red;border-radius: 50px;"><?php echo $countD; ?></span> <span <?php if($countD != 0){echo'style="color:white"';}else{echo'style="color:black"';} ?>>Expired Drugs</span>
					</a>

					<a href="report.php?StockChoose=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&CurrentStock=ok" class="btn"><i class="fa fa-check-circle"></i> Closed Stock Report</a>
					<hr>
			...
			<form action="report.php?iduser=<?php echo $_SESSION['id'];?>&dmac=ok&selectstockReporting=ok&StockChoose=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&stockInrepo=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmac" style="margin:auto auto 20px">
					<tr style="display:inline-block; margin-bottom:25px;">
						...
						<td>
							<select name="productId" id="idMed" class="chosen-select">
								<option value="">Select Product</option>
								<?php
								//Get All Product
								$productData=$connexion->query("SELECT *FROM products");
								while ($ligne=$productData->fetch(PDO::FETCH_OBJ))
								{
								?>
								<option value="<?php echo $ligne->pro_id;?>"><?php echo $ligne->productname;?></option>

								<?php
								
								}
									$productData->closeCursor();
								?>
							</select>
						</td>
			...
			if(isset($_GET['selectstockReporting']))
				{
					...
					if(isset($_POST['searchcustomPerso']))
					{
						...
						if(isset($_POST['productId']) AND $_POST['productId'] !=""){
							$productId = 'AND sti.pid='.$_POST['productId'];
						}else{
							$productId = "";
						}
				...
				<div id="dmacMedicReport" style="display:inline;">
					...
					//echo $comptStockIn;
					//echo 'SELECT *  FROM stockin_history sthI,stockin sti WHERE sthI.status = '.$statusCate.' AND sti.sid=sthI.sid '.$dailydateperso.'';
					...
					<table style="width:100%;">
						<tr>
							<td style="text-align:left; width:33.333%;">
								...
								<a href="stockReporting.php?iduser=<?php echo $_GET['iduser'];?>&dailydateperso=<?php echo $dailydateperso;?>&pid=<?php echo $_POST['productId']; ?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&stockInrepo=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&createRN=1" style="text-align:left" id="dmacmedicalpersopreview">
						...
						<?php
							...
							<thead>
								<tr>
									<th style="width:12%;text-align:center">No Report for thi Search</th>
								</tr> 
							</thead>
			...
			<form action="report.php?iduser=<?php echo $_SESSION['id'];?>&selectstockReporting=ok&StockChoose=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&stockOutrepo=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
			...
			if(isset($_GET['selectstockReporting']))
				...
				<div id="dmacMedicReport" style="display:inline;">
					...
					$resultStock=$connexion->query('SELECT *  FROM stockout_history sth,stockin sti WHERE sth.status = '.$statusCate.' '.$productId.' AND  sti.sid=sth.sid '.$dailydateperso.'');		
					...
					<table style="width:100%;">
						<tr>
							<td style="text-align:left; width:33.333%;">
								...
								<a href="stockReporting.php?iduser=<?php echo $_GET['iduser'];?>&dailydateperso=<?php echo $dailydateperso;?>&pid=<?php echo $_POST['productId']; ?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&stockOutrepo=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&createRN=1" style="text-align:left" id="dmacmedicalpersopreview">
			...
			<form action="report.php?iduser=<?php echo $_SESSION['id'];?>&selectstockReporting=ok&StockChoose=ok&ExpiredDrugs=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
			...
			if(isset($_GET['selectstockReporting']))
				{
					$stringResult = "";
					$dailydateperso = " sti.expireddate != '0000-00-00'";
					$docVisit="gnlPersoMedic";
					...
					if(isset($_POST['searchdailyPerso']))
					{
						if(isset($_POST['dailydatePerso']))
						{
							$dailydateperso = 'AND sti.expireddate=\''.$_POST['dailydatePerso'].'\'';
					...
					if(isset($_POST['searchmonthlyPerso']))
					{
						if(isset($_POST['monthlydatePerso']) AND isset($_POST['monthlydatePersoYear']))
						{
							...
							$dailydateperso = 'AND sti.expireddate>=\''.$umwaka.'-'.$ukwezi.'-01\' AND sti.expireddate<=\''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'\'';
					...
					if(isset($_POST['searchannualyPerso']))
					{
						if(isset($_POST['annualydatePerso']))
						{
							...
							$dailydateperso = 'AND sti.expireddate>=\''.$year.'-01-01\' AND sti.expireddate<=\''.$year.'-12-31\'';
					...
					if(isset($_POST['searchcustomPerso']))
					{
						if(isset($_POST['customdatedebutPerso']) AND isset($_POST['customdatefinPerso']))
						{
							...
							$dailydateperso = ' AND sti.expireddate>=\''.$debut.'\' AND sti.expireddate<=\''.$fin.'\'';
							$docVisit="customPersoMedic";
				...
				<div id="dmacMedicReport" style="display:inline;">
					...
					$resultStockExp=$connexion->query("SELECT *  FROM stockin sti WHERE sti.status = ".$statusCate." AND sti.expireddate < '$annee' ".$dailydateperso);		
					...
					if (isset($_GET['CurrentStock'])){ 
						?>
				<div id="selectdatePersoMedicReport">
					<h2>Closed Stock Report</h2>
					
				<form action="report.php?iduser=<?php echo $_SESSION['id'];?>&selectstockReporting=ok&StockChoose=ok&CurrentStock=ok<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				if(isset($_GET['selectstockReporting']))
					{
						$stringResult = "";
						$dailydateperso = "clo.closed_on != '0000-00-00'";
						$docVisit="gnlPersoMedic";
						...
						if(isset($_POST['searchdailyPerso']))
						{
							if(isset($_POST['dailydatePerso']))
							{
								$dailydateperso = 'AND clo.closed_on=\''.$_POST['dailydatePerso'].'\'';
						...
						if(isset($_POST['searchmonthlyPerso']))
						{
							if(isset($_POST['monthlydatePerso']) AND isset($_POST['monthlydatePersoYear']))
							{
								...
								$dailydateperso = 'AND clo.closed_on>=\''.$umwaka.'-'.$ukwezi.'-01\' AND clo.closed_on<=\''.$umwaka.'-'.$ukwezi.'-'.$daysmonth.'\'';
						...
						if(isset($_POST['searchannualyPerso']))
						{
							if(isset($_POST['annualydatePerso']))
							{
								...
								$dailydateperso = 'AND clo.closed_on>=\''.$year.'-01-01\' AND clo.closed_on<=\''.$year.'-12-31\'';
						...
						if(isset($_POST['searchcustomPerso']))
						{
							if(isset($_POST['customdatedebutPerso']) AND isset($_POST['customdatefinPerso']))
							{
								...
								$dailydateperso = ' AND clo.closed_on>=\''.$debut.'\' AND clo.closed_on<=\''.$fin.'\'';
								$docVisit="customPersoMedic";
					...
					<div id="dmacMedicReport" style="display:inline;">
						...
						$resultStockExp=$connexion->query("SELECT *  FROM stockin sto,closed_stock clo  WHERE sto.sid=clo.sid AND sto.status = ".$statusCate."  ".$dailydateperso);		
						//echo "SELECT *  FROM stockin sto,closed_stock clo  WHERE sto.sid=clo.sid AND sto.status = ".$statusCate."  ".$dailydateperso;						
						$resultStockExp->setFetchMode(PDO::FETCH_OBJ);
						...
						<table style="width:100%;">
							<tr>
								<td style="text-align:left; width:33.333%;">
									...
									<a href="Currentstock.php?iduser=<?php echo $_GET['iduser'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&<?php if(isset($_GET['MedicamentReport'])){echo "&MedicamentReport=ok";}else{if(isset($_GET['ConsumablesReport'])){echo "&ConsumablesReport=ok";}else{if(isset($_GET['MaterialsReport'])){echo "&MaterialsReport=ok";}}} ?>&createRN=1" style="text-align:left" id="dmacmedicalpersopreview">
	...
	<?php
		if (isset($_GET['clinicAssuRepo'])) {
			...
			<div id="selectdatePersoMedicReport">
			<h2 style="font-size:21px;border-bottom: 1px solid #ddd;">Report According To Assurances ( Clinic )</h2>
			<form action="report.php?audit=<?php echo $_SESSION['id'];?>&med=<?php echo $_GET['med'];?>&report=ok&dmac=ok<?php if(isset($_GET['clinicAssuRepo'])){echo'&clinicAssuRepo=ok';} ?><?php if(isset($_GET['gnlMedAssuReport'])){echo'&gnlMedAssuReport=ok';} ?>&selectPersoMedicAssu=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
		...
		<?php
			if(isset($_GET['Covid19report'])){
		?>
		<h3>Covid 19 Report</h3>
		<hr>
		<div id="selectdatePersoMedicReport">
			<form action="report.php?audit=<?php echo $_SESSION['id'];?>&report=ok&Covid19report=ok&selectCovidReport=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
		...
		?>
			...
			<table style="width:100%;">
				<tr>
					...
					<td style="text-align:center; width:40%;">
						<span style="position:relative; font-size:150%;"></i> <?php echo $stringResult;?> Report</span>
			...
			<?php
			// $resultCovid=$connexion->query('SELECT *FROM med_labo c,prestations_private p WHERE c.id_prestationExa=p.id_prestation AND `nompresta` LIKE "%covid%" AND c.prixprestationExa!=0.01 AND c.id_factureMedLabo!=0 '.$dailydateperso);
				...
				for($la=1;$la<=$assuCount;$la++)
				{
					...
					$presta_assuLab=strtolower('prestations_'.$assu);
					 ...
					 $resultGnlBillReport=$connexion->query('SELECT * FROM med_labo c,'.$presta_assuLab.' p WHERE c.id_prestationExa=p.id_prestation AND (p.nompresta LIKE "%covid%" OR p.namepresta LIKE "%covid%") AND c.prixprestationExa!=0.01 AND c.id_factureMedLabo!=0 AND c.id_assuLab='.$idassu.' '.$dailydateperso);
			...
			// $resultCovid->setFetchMode(PDO::FETCH_OBJ);

			// $comptCovid=$resultCovid->rowCount();
			if($counter != 0)
			{
			?>
				<a href="Covid-report.php?selectCovidReport=ok&dailydateperso=<?php echo $dailydateperso; ?>&stringResult=<?php echo $stringResult; ?>&paVisit=<?php echo $paVisit; ?>&createRN=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>">
					
					<button style="width:350px;margin-left: 60px;" type="submit" name="printMedicReportGnl" id="printMedicReportGnl" class="btn-large">
						<i class="fa fa-desktop fa-lg fa-fw"></i> Preview print <span class="badge"><?php echo number_format($counter);?></span>
					</button>
			...
			?>
				<table class="tablesorter tablesorter4" cellspacing="0" style="background:#fff; width:100%; margin-top:10px;"> 
					...
					<thead>
						<tr>
							<th style="width:12%;text-align:center">No Covid-19 Report Found!</th>
						</tr> 
					</thead>
