		...
		<div class="container">
			...
			<div class="nav-collapse">
				...
				<li class="">			
					...
					{
					?>
						<a href="reportDataM.php?english=english<?php if(isset($_GET['num'])){ echo '&num='.$_GET['num'];}if(isset($_GET['report'])){ echo '&report='.$_GET['report'];}if(isset($_GET['audit'])){ echo '&audit='.$_GET['audit'];}if(isset($_GET['cash'])){ echo '&cash='.$_GET['cash'];}if(isset($_GET['med'])){ echo '&med='.$_GET['med'];}if(isset($_GET['inf'])){ echo '&inf='.$_GET['inf'];}if(isset($_GET['lab'])){ echo '&lab='.$_GET['lab'];}if(isset($_GET['rec'])){ echo '&rec='.$_GET['rec'];}?>" class="btn"><?php echo getString(30);?></a>
					<?php
					}else{
					?>
						<a href="reportDataM.php?francais=francais<?php if(isset($_GET['num'])){ echo '&num='.$_GET['num'];}if(isset($_GET['report'])){ echo '&report='.$_GET['report'];}if(isset($_GET['audit'])){ echo '&audit='.$_GET['audit'];} if(isset($_GET['cash'])){ echo '&cash='.$_GET['cash'];} if(isset($_GET['med'])){ echo '&med='.$_GET['med'];}if(isset($_GET['inf'])){ echo '&inf='.$_GET['inf'];}if(isset($_GET['lab'])){ echo '&lab='.$_GET['lab'];}if(isset($_GET['rec'])){ echo '&rec='.$_GET['rec'];}?>" class="btn"><?php echo getString(29);?></a>
					<?php
					}					
					?>
						<br/>						
...
<?php
if(isset($_GET['report']) AND $_SESSION['dataM']!=NULL)
{
?>
...
<div class="account-container" style="width:90%; text-align:center;">
	...
	?>
		<ul>
			...
			{
			?>
				<li style="width:50%;"><a href="patients1.php?iduser=<?php echo $_SESSION['id'];?><?php if(isset($_GET['receptioniste'])){ echo '&receptioniste=ok';} if(isset($_GET['caissier'])){ echo '&caissier=ok';}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="margin-right:5px;" data-title="Patients"><i class="fa fa-wheelchair fa-lg fa-fw"></i> Patients</a></li>
	...
	<?php 
	if(!isset($_GET['num']) AND !isset($_GET['cash']) AND !isset($_GET['med']) AND !isset($_GET['gnlmed']) AND !isset($_GET['inf']) AND !isset($_GET['lab']) AND !isset($_GET['rec']))
	{
							...
							<table class="tablesorter" cellspacing="0" style="background-color:#FFF;margin-bottom:20px;">
								...
								<tr style="text-align:center;"> 
										...
										<table class="tablesorter" style="width:50%;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													...
													<td>
														<a href="reportDataM.php?gnlreport=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">General Report</a>
													</td>
												</tr>
											</tbody>
										</table>
									...
									<td style="text-align:center;">
										<table class="tablesorter"  style="width:100%;" align="center">
											<thead>
												<tr style="text-align:center;"> 
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td><a href="medecins1.php?report=ok<?php if(isset($_GET['receptioniste'])){ echo '&receptioniste='.$_GET['receptioniste'];} if(isset($_GET['caissier'])){ echo '&caissier='.$_GET['caissier'];}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">Report</a></td>
													
													<td><a href="reportDataM.php?gnlmed=ok&report=ok<?php if(isset($_GET['receptioniste'])){ echo '&receptioniste='.$_GET['receptioniste'];} if(isset($_GET['caissier'])){ echo '&caissier='.$_GET['caissier'];}?>" class="btn">General Report</a></td>
								...
								<tr style="text-align:center;display:none;">							
									...
									<td>
										<table class="tablesorter" >
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td><a href="patients_laboreportDataM.php?report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&laboreport=ok" class="btn">General Report</a></td>
													<!--
									...
									<td colspan=4>
										<table class="tablesorter">
											...
											<tbody>
												...
												{
													if($ligne->nomassurance!="PRIVATE")
													{
												?>
														<td>
															<a href="insurance_reportDataM.php?nomassu=<?php echo $ligne->nomassurance;?>&insugnlreport=ok&idassu=<?php echo $ligne->id_assurance;?>" id="insurance" class="btn"><?php echo $ligne->nomassurance;?></a>
														</td>
												<?php
													}
												}
										...
										<table class="tablesorter" style="width:50%;">
											...
											<tbody>
												<tr style="text-align:center;"> 
													...
													<td>
														<a href="reportDataM.php?gnlreporthosp=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="btn">General Report</a>
													</td>
												</tr>
											</tbody>
										</table>
	...
	?>
		...
		<table cellpadding=3 style="margin:auto auto 10px auto; padding: 10px; width:80%;">
			<tr>
				...
				<td style="font-size:18px; text-align:center; width:33.333%;">
					...
					<a href="reportDataM.php?num=<?php echo $_GET['num'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="text-align:center">
					
						<button id="persoMedicReport" class="btn-large">Medical Report</button>
						
					</a>
					
					<a style="display:none;" href="reportDataM.php?num=<?php echo $_GET['num'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&selectPersoBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="text-align:center">
		...
		<div id="selectdatePersoMedicReport">
			...
			<form action="reportDataM.php?num=<?php echo $_GET['num'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
		...
		<div id="selectdatePersoBillReport">
			...
			<form action="reportDataM.php?num=<?php echo $_GET['num'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmacbillperso=ok&selectPersoBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
		...
		?>
			...
			<a href="dmacreportDataM.php?num=<?php echo $_GET['num'];?>&dailydateperso=<?php echo $dailydateperso;?>&paVisit=<?php echo $paVisit;?>&divPersoMedicReport=ok" style="text-align:center" id="dmacmedicalpersopreview">
		...
		?>
			...
			<div id="dmacBillReport" style="display:inline">
				...
				<a href="dmacreportDataM.php?num=<?php echo $_GET['num'];?>&dailydateperso=<?php echo $dailydateperso;?>&divPersoBillReport=ok&paVisit=<?php echo $paVisit;?>" style="text-align:center" id="dmacbillpersopreview">
	...
	?>
		...
		<table cellpadding=3 style="margin:auto auto 10px auto; padding: 10px; width:95%;">
			<tr>
				<td style="font-size:18px; text-align:center; width:33.333%;">
					...
					<a href="reportDataM.php?audit=<?php echo $_SESSION['id'];?>&gnlreport=ok&selectGnlMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="text-align:center;display:none;">
					
						<button id="gnlMedicReport" class="btn-large" onclick="ShowDivReport('divGnlMedicReport')" >Medical Report</button>
						
					</a>
					
					<a style="display:none;" href="reportDataM.php?audit=<?php echo $_SESSION['id'];?>&gnlreport=ok&selectGnlBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="text-align:center">
		...
		<div id="selectdateGnlMedicReport" style="display:inline">
			...
			<form action="reportDataM.php?audit=<?php echo $_SESSION['id'];?>&gnlreport=ok&dmacgnl=ok&selectGnlMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
		...
		<div id="selectdateGnlBillReport" style="display:inline">
			...
			<form action="reportDataM.php?audit=<?php echo $_SESSION['id'];?>&gnlreport=ok&dmacbillgnl=ok&selectGnlBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
	...
	<?php
		...
		?>
			<div id="divGnlMedicReport" style="display:inline">
				...
				<a href="dmacreportDataM.php?dailydategnl=<?php echo $dailydategnl;?>&divGnlMedicReport=ok&gnlpatient=ok&paVisit=<?php echo $paVisitgnl;?>" style="text-align:center" id="dmacmedicalgnlpreview">
			...
			<table style="width:100%;">
				<tr>
					<td style="text-align:left; width:33.333%;">
						...
						<a href="dmacreportDataM.php?dailydategnl=<?php echo $dailydategnl;?>&divGnlBillReport=ok&gnlpatient=ok&paVisit=<?php echo $paVisitgnl;?>&stringResult=<?php echo $stringResult;?>" style="text-align:center" id="dmacbillgnlpreview">
	...
	?>
		...
		<table cellpadding=3 style="margin:auto auto 10px auto; padding: 10px; width:95%;">
			<tr>
				<td style="font-size:18px; text-align:center; width:33.333%;">
					...
					<a href="reportDataM.php?audit=<?php echo $_SESSION['id'];?>&gnlreporthosp=ok&selectGnlMedicHosp=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="text-align:center;display:none;">
					
						<button id="gnlMedicReport" class="btn-large" onclick="ShowDivReport('divGnlMedicReport')" >Medical Report</button>
						
					</a>
					
					<a style="display:none;" href="reportDataM.php?audit=<?php echo $_SESSION['id'];?>&gnlreporthosp=ok&selectGnlBillHosp=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="text-align:center">
		...
		<div id="selectdateGnlMedicReport" style="display:inline">
			...
			<form action="reportDataM.php?audit=<?php echo $_SESSION['id'];?>&gnlreporthosp=ok&dmacgnl=ok&selectGnlMedicHosp=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
		...
		<div id="selectdateGnlBillReport" style="display:inline">
			...
			<form action="reportDataM.php?audit=<?php echo $_SESSION['id'];?>&gnlreporthosp=ok&dmacbillgnl=ok&selectGnlBillHosp=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
	...
	?>
		...
		<div id="selectdatePersoBillReport">
			...
			<form action="reportDataM.php?cash=<?php echo $_GET['cash'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmacbillperso=ok&selectPersoBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmacbillperso" style="margin:auto auto 20px">
					<tr style="display:inline-block; margin-bottom:25px;">
						...
						{
						?>
							<a href="reportDataM.php?cash=<?php echo $_GET['cash'];?>&audit=ok&report=ok" id="nomassurance" style="text-align:center;width:100px;" class="btn">Full Report</a>
						<?php
						} */
						?>
						</td>
			...
			<table style="width:100%;">
				<tr>
					<td style="text-align:left; width:33.333%;">
						...
						<a href="cashier_reportDataM.php?cash=<?php echo $_GET['cash'];?>&dailydateperso=<?php echo $dailydateperso;?>&caVisit=<?php echo $caVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoBillReport=ok&createRN=1" style="text-align:center" id="dmacbillpersopreview">
		...
		?>
					...
					<a href="cashier_reportDataM.php?cash=<?php echo $_GET['cash'];?>&dailydateperso=<?php echo $dailydateperso;?>&divPersoBillReport=ok&caVisit=<?php echo $caVisit;?>" style="text-align:center" id="dmacbillpersopreview">
	...
	?>
		...
		<div id="selectdatePersoMedicReport" style="<?pNetadmin/*  if(isset($_GET['gnlMedMedicReport']) OR isset($_SESSION['codeM'])){ echo 'display:inline';}else{ echo 'display:none';} */?>">
				<h2>Medical</h2>
				
			<form action="reportDataM.php?med=<?php echo $_GET['med'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&gnlMedMedicReport&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmac" style="margin:auto auto 20px">
					<tr style="display:inline-block; margin-bottom:25px;">
						...
						{
						?>
							<a href="reportDataM.php?med=<?php echo $_GET['med'];?>&audit=ok&report=ok" id="nomassurance" style="text-align:center;width:100px;" class="btn">Full Report</a>
						<?php
						}
						?>
						</td>
		...
		<div id="selectdatePersoBillReport" style="<?php if(isset($_GET['gnlMedBillReport'])){ echo 'display:inline';}else{ echo 'display:none';}?>">
			...
			<form action="reportDataM.php?med=<?php echo $_GET['med'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&gnlMedBillReport&selectPersoBill=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
...
<?php
			...
			<table style="width:100%;">
				<tr>
					<td style="text-align:left; width:33.333%;">
						...
						<a href="doctor_reportDataM.php?med=<?php echo $_GET['med'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&createRN=1<?php if(isset($_GET['receptioniste'])){ echo '&receptioniste='.$_GET['receptioniste'];} if(isset($_GET['caissier'])){ echo '&caissier='.$_GET['caissier'];}?>" style="text-align:left" id="dmacmedicalpersopreview">
		...
		<?php
			...
			<div id="dmacBillReport" style="display:inline;">
				...
				<table style="width:100%;">
					...
					<a href="doctor_reportDataM.php?med=<?php echo $_GET['med'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoBillReport=ok&createRN=1<?php if(isset($_GET['receptioniste'])){ echo '&receptioniste='.$_GET['receptioniste'];} if(isset($_GET['caissier'])){ echo '&caissier='.$_GET['caissier'];}?>" style="text-align:left" id="dmacbillingpersopreview">
		...
		<?php
				...
				if(isset($_GET['med']))
				{
					...
					?>
						...
						<a href="doctor_reportDataM.php?med=<?php echo $_GET['med'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&divPersoMedicReport=ok<?php if(isset($_GET['receptioniste'])){ echo '&receptioniste='.$_GET['receptioniste'];} if(isset($_GET['caissier'])){ echo '&caissier='.$_GET['caissier'];}?>" style="text-align:center" id="dmacmedicalpersopreview">
	...
	?>
		...
		<div id="selectdatePersoBillReport" style="<?php if(isset($_GET['gnlMedBillReport'])){ echo 'display:inline';}else{ echo 'display:none';}?>">
			...
			<form action="reportDataM.php?gnlmed=<?php echo $_GET['gnlmed'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&gnlMedBillReport&selectPersoBill=ok<?php if(isset($_GET['receptioniste'])){ echo '&receptioniste='.$_GET['receptioniste'];} if(isset($_GET['caissier'])){ echo '&caissier='.$_GET['caissier'];}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
...
<?php
			...
			<table style="width:100%;">
				<tr>
					<td style="text-align:left; width:33.333%;">
						...
						<a href="doctor_reportDataM.php?gnlmed=<?php echo $_GET['gnlmed'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?>&stringResult=<?php echo $stringResult;?>&divPersoMedicReport=ok&createRN=1<?php if(isset($_GET['receptioniste'])){ echo '&receptioniste='.$_GET['receptioniste'];} if(isset($_GET['caissier'])){ echo '&caissier='.$_GET['caissier'];}?>" style="text-align:left" id="dmacmedicalpersopreview">
	...
	?>
		...
		<div id="selectdatePersoMedicReport">
			...
			<form action="reportDataM.php?inf=<?php echo $_GET['inf'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmac" style="margin:auto auto 20px">
					<tr style="display:inline-block; margin-bottom:25px;">
						...
						{
						?>
							<a href="reportDataM.php?inf=<?php echo $_GET['inf'];?>&audit=ok&report=ok" id="nomassurance" style="text-align:center;width:100px;" class="btn">Full Report</a>
						<?php
						}
						?>
						</td>
...
<?php
		...
		?>
			...
			<a href="nurse_reportDataM.php?inf=<?php echo $_GET['inf'];?>&dailydateperso=<?php echo $dailydateperso;?>&infVisit=<?php echo $infVisit;?>&divPersoMedicReport=ok" style="text-align:center" id="dmacmedicalpersopreview">
	...
	?>
		...
		<div id="selectdatePersoMedicReport">
			...
			<form action="reportDataM.php?lab=<?php echo $_GET['lab'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmac" style="margin:auto auto 20px">
					<tr style="display:inline-block; margin-bottom:25px;">
						...
						{
						?>
							<a href="reportDataM.php?lab=<?php echo $_GET['lab'];?>&audit=ok&report=ok" id="nomassurance" style="text-align:center;width:100px;" class="btn">Full Report</a>
						<?php
						}
						?>
						</td>
...
<?php
		...
		?>
			...
			<a href="labs_reportDataM.php?lab=<?php echo $_GET['lab'];?>&dailydateperso=<?php echo $dailydateperso;?>&labVisit=<?php echo $labVisit;?>&divPersoMedicReport=ok" style="text-align:center" id="dmacmedicalpersopreview">
	...
	?>
		...
		<div id="selectdatePersoMedicReport">
			...
			<form action="reportDataM.php?rec=<?php echo $_GET['rec'];?>&audit=<?php echo $_SESSION['id'];?>&report=ok&dmac=ok&selectPersoMedic=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
				...
				<table id="dmac" style="margin:auto auto 20px">
					<tr style="display:inline-block; margin-bottom:25px;">
						...
						{
						?>
							<a href="reportDataM.php?rec=<?php echo $_GET['rec'];?>&audit=ok&report=ok" id="nomassurance" style="text-align:center;width:100px;" class="btn">Full Report</a>
						<?php
						}
						?>
						</td>
...
<?php
		...
		?>
			...
			<a href="recep_reportDataM.php?rec=<?php echo $_GET['rec'];?>&dailydateperso=<?php echo $dailydateperso;?>&recVisit=<?php echo $recVisit;?>&divPersoMedicReport=ok" style="text-align:center" id="dmacmedicalpersopreview">
