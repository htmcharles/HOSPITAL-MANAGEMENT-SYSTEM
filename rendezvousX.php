...
<div class="account-container" style="width:90%">
	...
	<h2>Formulaire Rendez-vous</h2>
		...
		<form action="traitement_rendezvous.php" onsubmit="return controlFormRDV(this)" method="post" enctype="multipart/form-data">
			...
			<table class="cons-info" cellpadding=10 style="margin:0;margin:20px auto auto auto;background:#eee;width:85%;">
			...
			<table class="cons-info" style="background:#f8f8f8;border: none;">
...
<div>
	<footer style="bottom: 0px; width: 100%; text-align: center; background: #fff; border-top: 1px solid #eee; padding: 10px 0px; vertical-align: middle;">
		<p style="margin:0"><span style="color:#a00000">Clinic Plus®</span> is a product of <span style="font-style:bold;">Innovate Solutions Ltd</span>. ©2022-2016 All rights reserved.</p>
	</footer>
</div>
