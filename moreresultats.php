...
/* 
	...
	?>
		...
		$resultMoreMedLabo=$connexion->prepare('SELECT *FROM more_med_labo mml WHERE mml.numero=:num AND mml.id_medlabo=:idmedLab ORDER BY mml.id_moremedlabo ASC');		
		...
		?>
				...
				<table class="tablesorter tablesorter2" cellspacing="0" style="background:#fff; width:100%; margin-top:10px;"> 
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td>
								<input type="hidden" id="idmoremedLaboResult<?php echo $l;?>" name="idmoremedLaboResult[]" style="background: rgb(250, 250, 250) none repeat scroll 0% 0%;" value="<?php echo $ligneMoreMedLabo->id_moremedlabo;?>"/>
								
								<input type="hidden" id="idprestationExa<?php echo $l;?>" name="idprestationExa[]" style="background: rgb(250, 250, 250) none repeat scroll 0% 0%;" value="<?php echo $ligneMoreMedLabo->id_prestationExa;?>"/>
							...
							<td>
								<input type="text" id="moreresultats" name="moreresultats[]" style="background: rgb(250, 250, 250) none repeat scroll 0% 0%;width:130px" value="<?php if(isset($_GET['updateidmoremedLabo'])){ echo $ligneMoreMedLabo->autreresultats;}else{ echo '';}?>" placeholder="Taper les résultats ici..." /> <span style="font-size:80%; font-weight:normal;padding:5px;"><?php if($mesure!=''){ echo $mesure;}?></span>
							</td>
							...
							{
							?>
								<select name="<?php echo $l;?>" id="valeur<?php echo $l;?>" style="width:200px;" onchange="ShowMinMax()">
							...
							<?php
								...
								if(isset($_GET['updateidmoremedLabo']))
								{								
									echo "<input type='text' name='".$l."' id='valeur'".$l."' style='width:100px;' value='".$ligneMoreMedLabo->valeurLab."'/>";
								}else{ 
									echo "<input type='text' name='".$l."' id='valeur'".$l."' style='width:100px;' value=''/>";
								}
							...
							<td>
								<input type="text" id="min<?php echo $l;?>" name="min[]" style="width:80px" value="<?php if(isset($_GET['updateidmoremedLabo'])){ echo $ligneMoreMedLabo->minresultats;}else{ echo '';}?>"/>
							</td>
							
							<td>
								<input type="text" id="max<?php echo $l;?>" name="max[]" style="width:80px" value="<?php if(isset($_GET['updateidmoremedLabo'])){ echo $ligneMoreMedLabo->maxresultats;}else{ echo '';}?>"/>
							</td>
			...
			<input type='hidden' id='iVal' value='<?php echo $l-1;?>'/>
		<?php
		}
		?>
