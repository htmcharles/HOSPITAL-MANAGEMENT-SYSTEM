...
if(isset($_POST['checkprestaOrtho']))
{
	...
	for($i=0;$i<sizeof($addOrtho);$i++)
	{
		...
		if($comptOrtho==0)
		{
			...
			$resultatOrtho=$connexion->prepare('INSERT INTO med_ortho_hosp (datehosp,id_prestationOrtho,prixprestationOrtho,prixautrePrestaO,qteOrtho,id_assuOrtho,insupercentOrtho,numero,id_uM,id_uI,id_uO,dateortho,id_hospOrtho) VALUES(:datehosp,:idPrestaOrtho,:prixPresta,:prixautreOrtho,:qteOrtho,:idassu,:bill,:numero,:id_uM,:id_uI,:id_uO,:dateortho,:idhospAdd)');
			...
			if($addOrthoautre[$i]!="")
			{
				...
				if($ligneLastId=$searchLastId->fetch())
				{
					...
					if($comptSearchOrtho!=0)				
					{
						...
						$resultatOrtho=$connexion->prepare('INSERT INTO med_ortho_hosp (datehosp,id_prestationOrtho,prixprestationOrtho,qteOrtho,id_assuOrtho,insupercentOrtho,numero,id_uM,id_uI,id_uO,id_hospOrtho,id_factureMedOrtho) VALUES(:datehosp,:idPresta,:prixPresta,:qteOrtho,:idassu,:bill,:numero,:id_uM,:id_uI,:id_uO,:idhospAdd,:idfacture)');
						$resultatOrtho->execute(array(
						'datehosp'=>$annee,
						'idPresta'=>$lastIdPresta,
						'prixPresta'=>$addOrthoautreprix[$i],
