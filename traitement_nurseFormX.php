	...
	if(isset($_POST['addConsult']) OR isset($_POST['addAutreConsult']))
	{
		...
		if(isset($_POST['addConsult']))
		{
			...
			for($x=0;$x<sizeof($idPrestaConsu);$x++)
			{
				...
				if($idPrestaConsu[$x] != "")
				{
					$resultat=$connexion->prepare('INSERT INTO med_consult (dateconsu,id_prestationConsu,prixprestationConsu,id_uInfConsu,id_assuServ,insupercentServ,numero,id_uM,id_consuMed) VALUES(:dateconsu,:idPrestaConsu,:prixPrestaConsu,:id_uI,:idassu,:bill,:numero,:id_uM,:idconsuAdd)');
