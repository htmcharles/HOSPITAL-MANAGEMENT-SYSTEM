						...
						<tr style="text-align:center;">
							...
							<td>
								<?php
									...
									/*$getqteMedConsom=$qteMedConsom->rowCount();
								  	if ($getqteMedConsom != 0) {
								  		while ($listqte=$qteConsom) {
								  	...
								  	/*$qteaddMedConsom=$connexion->prepare('SELECT qteConsom,id_prestationConsom FROM med_consom_hosp mco WHERE mco.numero=:num AND mco.id_factureMedConsom="" AND mco.id_hospConsom=:idhosp  ORDER BY mco.id_medconsom');		
									$qteMedConsom->execute(array(
									'num'=>$_GET['num'],
									'idhosp'=>$_GET['idhosp']
									));
...
<div>
	<footer style="bottom: 0px; width: 100%; text-align: center; background: #fff; border-top: 1px solid #eee; padding: 10px 0px; vertical-align: middle;">
		<p style="margin:0"><span style="color:#a00000">Medical FIle®</span> is a product of <span style="font-style:bold;">CodeBlock</span>. ©2022-<?php echo date('Y');?> All rights reserved.</p>
	</footer>
</div>
