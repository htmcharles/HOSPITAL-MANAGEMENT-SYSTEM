...
if($connect==true AND ($comptidM!=0 OR $comptidD!=0 OR $comptidC!=0 OR $comptidI!=0 OR $comptidS!=0))
{
	if($status==1)
	{
?>
...
<div class="account-container" style="width:90%; text-align:center;">
	...
	<?php 
	if(!isset($_GET['num']) AND !isset($_GET['cash']) AND !isset($_GET['med']) AND !isset($_GET['gnlmed']) AND !isset($_GET['gnlcashier']) AND !isset($_GET['inf']) AND !isset($_GET['lab']) AND !isset($_GET['rec']) AND !isset($_GET['codeI']) AND !isset($_SESSION['codeI']) AND !isset($_SESSION['codeS']))
	{
								...
								<td>
									...
									<td>
										<table class="tablesorter" >
											...
											<tbody>
												<tr style="text-align:center;"> 
													<td><a href="patients_laboreport.php?report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>&chooseReport=ok" class="btn">General Report</a></td>
													<!--
					...
					<tr>					
						<td>
							...
							<table class="tablesorter" cellspacing="0" style="background-color:#FFF;margin-bottom:20px;">
								...
								<tr style="text-align:center;">							
									<td>
										<table class="tablesorter" style="text-align:center;position: relative;left: 35%;">
											<thead>
												<tr > 
													<th>Cashiers</th>
												</tr>
...
<?php
	...
	?>
		...
		<table cellpadding=3 style="background:#fff; border:1px solid #eee; border-radius:4px; margin:auto auto 10px auto; padding: 10px; width:80%;position: relative;right: 120px;">
			<?php
			if(!isset($_SESSION['codeM']))
			{
			?>
...
<?php
	...
	?>
		...
		<table cellpadding=3 style="background:#fff; border:1px solid #eee; border-radius:4px; margin:auto auto 10px auto; padding: 10px; width:80%;">
			...
			<tr>
				<!-- <td></td> -->
				<td style="position: relative;right: 120px;">
	...
	?>
		...
		<?php if (isset($_GET['MedicamentReport'])){
		 ?>
				<br><br>
					<hr>
					<a href="report.php?StockChoose=ok&MedicamentReport=ok&stockInrepo=ok" class="btn"><i class="fa fa-arrow-circle-up"></i> Stok In</a>
					<a href="report.php?StockChoose=ok&MedicamentReport=ok&stockOutrepo=ok" class="btn"><i class="fa fa-arrow-circle-down"></i> Stok Out</a>

					<a href="report.php?StockChoose=ok&MedicamentReport=ok&ExpiredDrugs=ok"  <?php if($countD != 0){echo'class="btn flashing"';}else{echo'class="btn"';} ?>><i class="fa fa-warning" style="color: black;"></i> <span style="padding: 2px 7px;color:white;font-weight:bold;background: red;border-radius: 50px;"><?php echo $countD; ?></span> <span <?php if($countD != 0){echo'style="color:white"';}else{echo'style="color:black"';} ?>>Expired Drugs</span></a>
					<hr>
			...
			<form action="report.php?iduser=<?php echo $_SESSION['id'];?>&dmac=ok&&selectstockReporting=ok&StockChoose=ok&MedicamentReport=ok&stockInrepo=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
			...
			<form action="report.php?iduser=<?php echo $_SESSION['id'];?>&selectstockReporting=ok&StockChoose=ok&MedicamentReport=ok&stockOutrepo=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
			...
			<form action="report.php?iduser=<?php echo $_SESSION['id'];?>&selectstockReporting=ok&StockChoose=ok&MedicamentReport=ok&ExpiredDrugs=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" method="post" style="margin:auto;padding:5px;width:90%;">
