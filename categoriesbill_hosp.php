...
if(isset($_GET['deleteMedConsu']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableServ";</script>';
...
if(isset($_GET['deleteMedInf']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableInf";</script>';
...
if(isset($_GET['deleteMedSurge']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableSurge";</script>';
...
if(isset($_GET['deleteMedLabo']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableLab";</script>';
...
if(isset($_GET['deleteMedRadio']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableRad";</script>';
...
if(isset($_GET['deleteMedKine']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableKine";</script>';
...
if(isset($_GET['deleteMedConsom']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableConsom";</script>';
...
if(isset($_GET['deleteMedMedoc']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableMedoc";</script>';
...
if(isset($_GET['deleteMedOrtho']))
{
	...
	echo '<script type="text/javascript">document.location.href="categoriesbill_hosp.php?inf='.$_GET['inf'].'&num='.$_GET['num'].'&idhosp='.$_GET['idhosp'].'&id_uM='.$_GET['id_uM'].'&datehosp='.$_GET['datehosp'].'&idassu='.$_GET['idassu'].'&idbill='.$_GET['idbill'].'&numroom='.$_GET['numroom'].'&numlit='.$_GET['numlit'].'&'.$previewback.'&'.$sortie.'#tableOrtho";</script>';
...
if($connect==true AND ($comptidI!=0 OR $comptidO!=0 OR $comptidX!=0 OR $comptidL!=0 OR $comptidC!=0) AND isset($_GET['num']))
{
	if($status==1)
	{
...
if($comptidI!=0 OR $comptidO!=0 OR $comptidC!=0 OR $comptidX!=0 OR $comptidL!=0)
{
?>
							...
							if($comptPresta!=0)
							{
								...
								?>
									...
									?>
										...
										:<input type="text" id="minuteout" name="minuteout" value="<?php if($heureSortie!=0) echo $minuteSortie;?>" style="width:50px" required/>
					...
					?>
						<tr style="text-align:center;">
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								<?php
									if ($lignePresta->prixpresta == 0 AND $lignePresta->statupresta == 1)
									{
										echo "<label class='badge'>This acts is not covered by insurance! Please enter the private price</label>" ;
									}elseif ($lignePresta->statupresta == 0) {
										echo "<label class='badge'>The price of this act is not sure!! Check price (New act or act doesn't exit in tarriff)</label>" ;
									}
								?>
								<input type="text" name="prixprestaSurge[]" style="width:100px; text-align:center" id="prixprestaSurge" class="prixprestaSurge" value="<?php echo $lignePresta->prixpresta; ?>" onchange="ShowSaveSurge(<?php echo $l;?>)"/><!-- 
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="prixprestaSurge[]" style="width:100px; text-align:center" id="prixprestaSurge" class="prixprestaSurge" value="<?php echo $lignePresta->prixpresta;?>" onchange="ShowSaveSurge(<?php echo $l;?>)"/><!-- <input type="text" name="prixprestaSurge[]" style="width:100px; text-align:center" id="prixprestaSurge" class="prixprestaSurge" value="<?php if($ligneMedSurge->prixprestationSurge >0){ echo $ligneMedSurge->prixprestationSurge; }else{ if($lignePresta->prixpresta!=-1){ echo $lignePresta->prixpresta; }else{ echo "";}}?>" onchange="ShowSaveSurge(<?php echo $l;?>)"/> -->
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								<?php
									if ($lignePresta->prixpresta != 0 AND $lignePresta->statupresta == 1)
									{
										echo "<label class='badge'>This acts is not covered by insurance! Please enter the Percentage is 100%</label>" ;
									}
								?>
								<input type="text" id="percentSurge" name="percentSurge[]" class="percentSurge" style="width:30px; text-align:center;<?php if($comptidI!=0){ echo 'background:#F8F8F8;';}?>" value="<?php if(($lignePresta->prixpresta == 0 AND $lignePresta->statupresta == 1) OR ($lignePresta->prixpresta != 0 AND $lignePresta->statupresta == 2)){ $newbill = 100; echo $newbill;}else{ echo $bill;}?>" <?php if($comptidI!=0){ echo 'readonly="readonly"';}?><?php  if(($lignePresta->prixpresta == 0 AND $lignePresta->statupresta == 1) OR ($lignePresta->prixpresta != 0 AND $lignePresta->statupresta == 2)){ echo $newbill; }?>/> %
					...
					?>
						<tr style="text-align:center;">
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="prixprestaInf[]" style="width:100px; text-align:center" id="prixprestaInf" class="prixprestaInf" value="<?php echo $lignePresta->prixpresta; ?>" onchange="ShowSaveInf(<?php echo $f;?>)"/>
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="prixprestaInf[]" style="width:100px; text-align:center" id="prixprestaInf" class="prixprestaInf" value="<?php echo $lignePresta->prixpresta; ?>" onchange="ShowSaveInf(<?php echo $f;?>)"/><!-- <input type="text" name="prixprestaInf[]" style="width:100px; text-align:center" id="prixprestaInf" class="prixprestaInf" value="<?php if($ligneMedInf->prixprestation!=""){ echo $ligneMedInf->prixprestation; }else{ if($lignePresta->prixpresta!=-1){ echo $lignePresta->prixpresta; }else{ echo "";}}?>" onchange="ShowSaveInf(<?php echo $f;?>)"/> -->
...
<input type="hidden" name="idprestaInf[]" style="width:100px;display:none;" id="idprestaInf" value="0"/>
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" id="percentInf" name="percentInf[]" class="percentInf" style="width:30px; text-align:center;<?php if($comptidI!=0){ echo 'background:#F8F8F8;';}?>" value="<?php  echo $bill; ?>"/> %
					...
					?>
						<tr style="text-align:center;">
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="prixprestaLab[]" style="width:100px; text-align:center" id="prixprestaLab"  class="prixprestaLab" value="<?php echo $lignePresta->prixpresta; ?>" onchange="ShowSaveLab(<?php echo $g;?>)"/><!-- <input type="text" name="prixprestaLab[]" style="width:100px; text-align:center" id="prixprestaLab"  class="prixprestaLab" value="<?php if($ligneMedLabo->prixprestationExa!=""){ echo $ligneMedLabo->prixprestationExa; }else{ if($lignePresta->prixpresta!=-1){ echo $lignePresta->prixpresta; }else{ echo "";}}?>" onchange="ShowSaveLab(<?php echo $g;?>)"/> -->
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" id="percentLab" name="percentLab[]" class="percentLab" style="width:30px; text-align:center;<?php if($comptidI!=0){ echo 'background:#F8F8F8;';}?>" value="<?php echo $bill;?>"/> %
					...
					?>
						<tr style="text-align:center;">
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="prixprestaRad[]" style="width:100px; text-align:center" id="prixprestaRad"  class="prixprestaRad" value="<?php echo $lignePresta->prixpresta; ?>" onchange="ShowSaveRad(<?php echo $h;?>)"/><!-- <input type="text" name="prixprestaRad[]" style="width:100px; text-align:center" id="prixprestaRad"  class="prixprestaRad" value="<?php if($ligneMedRadio->prixprestationRadio!=""){ echo $ligneMedRadio->prixprestationRadio; }else{ if($lignePresta->prixpresta!=-1){ echo $lignePresta->prixpresta; }else{ echo "";}}?>" onchange="ShowSaveRad(<?php echo $h;?>)"/> -->
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" id="percentRad" name="percentRad[]" class="percentRad" style="width:30px; text-align:center;<?php if($comptidI!=0){ echo 'background:#F8F8F8;';}?>" value="<?php echo $bill; ?>"/> %
					...
					?>
						<tr style="text-align:center;">
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="prixprestaConsom[]" style="width:100px; text-align:center" id="prixprestaConsom"  class="prixprestaConsom" value="<?php echo $lignePresta->prixpresta; ?>" onchange="ShowSaveConsom(<?php echo $j;?>)"/><!-- <input type="text" name="prixprestaConsom[]" style="width:100px; text-align:center" id="prixprestaConsom"  class="prixprestaConsom" value="<?php if($ligneMedConsom->prixprestationConsom!=""){ echo $ligneMedConsom->prixprestationConsom; }else{ if($lignePresta->prixpresta!=-1){ echo $lignePresta->prixpresta; }else{ echo "";}}?>" onchange="ShowSaveConsom(<?php echo $j;?>)"/> -->
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" id="percentConsom" name="percentConsom[]" class="percentConsom" style="width:30px; text-align:center;<?php if($comptidI!=0){ echo 'background:#F8F8F8;';}?>" value="<?php echo $bill; ?>"/> %
					...
					?>
						<tr style="text-align:center;">
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="prixprestaMedoc[]" style="width:100px; text-align:center" id="prixprestaMedoc" class="prixprestaMedoc" value="<?php echo $lignePresta->prixpresta; ?>" onchange="ShowSaveMedoc(<?php echo $k;?>)"/><!-- <input type="text" name="prixprestaMedoc[]" style="width:100px; text-align:center" id="prixprestaMedoc" class="prixprestaMedoc" value="<?php if($ligneMedMedoc->prixprestationMedoc >0){ echo $ligneMedMedoc->prixprestationMedoc; }else{ if($lignePresta->prixpresta!=-1){ echo $lignePresta->prixpresta; }else{ echo "";}}?>" onchange="ShowSaveMedoc(<?php echo $k;?>)"/> -->
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" id="percentMedoc" name="percentMedoc[]" class="percentMedoc" style="width:30px; text-align:center;<?php if($comptidI!=0){ echo 'background:#F8F8F8;';}?>" value="<?php echo $bill; ?>"/> %
					...
					?>
						<tr style="text-align:center;">
							...
							for($i=1;$i<=$assuCount;$i++)
							{
                                ...
                                ?>
									...
									<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
										...
										?>
										<input type="text" name="prixprestaKine[]" style="width:100px; text-align:center" id="prixprestaKine" class="prixprestaKine" value="<?php echo $lignePresta->prixpresta; ?>" onchange="ShowSaveKine(<?php echo $o;?>)"/><!-- <input type="text" name="prixprestaKine[]" style="width:100px; text-align:center" id="prixprestaKine" class="prixprestaKine" value="<?php if($ligneMedKine->prixprestationKine >0){ echo $ligneMedKine->prixprestationKine; }else{ if($lignePresta->prixpresta!=-1){ echo $lignePresta->prixpresta; }else{ echo "";}}?>" onchange="ShowSaveKine(<?php echo $o;?>)"/> -->
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" id="percentKine" name="percentKine[]" class="percentKine" style="width:30px; text-align:center;<?php if($comptidI!=0){ echo 'background:#F8F8F8;';}?>" value="<?php echo $bill; ?>"/> %
					...
					?>
						<tr style="text-align:center;">
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" id="percentOrtho" name="percentOrtho[]" class="percentOrtho" style="width:30px; text-align:center;<?php if($comptidI!=0 OR $comptidO!=0){ echo 'background:#F8F8F8;';}?>" value="<?php echo $bill;  ?>"/> %
					...
					<tbody>
						...
						<tr style="text-align:center;">
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="prixprestaConsu[]" style="width:100px; text-align:center" id="prixprestaConsu" class="prixprestaConsu" value="<?php  echo $lignePresta->prixpresta; ?>" onchange="ShowSaveConsu(<?php echo $e;?>)"/><!-- <input type="text" name="prixprestaConsu[]" style="width:100px; text-align:center" id="prixprestaConsu" class="prixprestaConsu" value="<?php if($ligneMedConsult->prixprestationConsu >0){ echo $ligneMedConsult->prixprestationConsu; }else{ if($lignePresta->prixpresta!=-1){ echo $lignePresta->prixpresta; }else{ echo "";}}?>" onchange="ShowSaveConsu(<?php echo $e;?>)"/> -->
							...
							<td style="<?php if(!isset($_SESSION['codeCash'])){ echo 'display:none;';}?>">
								...
								?>
								<input type="text" name="percentConsu[]" class="percentConsu" id="percentConsu<?php echo $e;?>" style="width:30px; text-align:center;<?php if($comptidI!=0){ echo 'background:#F8F8F8;';}?>;" value="<?php echo $bill; ?>"/> %
