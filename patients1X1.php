...
$(document).ready( function() {
  ...
  $('#r').keyup( function(){
	...
	?>
		...
		?>
				<tr style="text-align:center;<?php if($ligneR->status==0){ echo 'background:rgba(255,0,0,0.15);';}?>"> 
		...
		?>				
			...
			<?php
				while($ligneR=$resultatsR->fetch())//on récupère la liste des éléments
				{
					$fullname=$ligneR->nom_u.' '.$ligneR->prenom_u;
		?>
				<tr style="text-align:center;<?php if($ligneR->status==0){?>background:rgba(255,0,0,0.15)<?php ;}?>"> 
					<td><?php echo $ligneR->numero;?></td>
					<td><?php echo $ligneR->reference_id;?></td>
					<td><?php echo $fullname;?></td>
