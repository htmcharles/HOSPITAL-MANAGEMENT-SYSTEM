						...
						<tr style="text-align:center;">
							...
							if($ligneConsult->id_typeconsult==NULL AND ($ligneConsult->prixautretypeconsult==0 OR $ligneConsult->prixautretypeconsultCCO==0))
							{
								...
								echo $ligneConsult->autretypeconsult.'<img src="icones/s_warn.png" style="width:20px;height:20px;margin-left:20px;"/></td>
									...
									<td>
										<input type="text" name="prixtypeconsultCCO[]" style="width:100px; text-align:center" id="prixtypeconsultCCO'.$i.'" class="prixtypeconsultCCO" value="" placeholder="Tarrif ici..."/>
									</td>';
						...
						<tr style="text-align:center;">
							...
							if($ligneMedConsult->id_prestationConsu==NULL AND ($ligneMedConsult->prixautreConsu==0 OR $ligneMedConsult->prixautreConsuCCO==0))
							{
								...
								echo $ligneMedConsult->autreConsu.'<img src="icones/s_warn.png" style="width:20px;height:20px;margin-left:20px;"/></td>
									...
									<td>
										<input type="text" name="prixprestaConsuCCO[]" style="width:100px; text-align:center" id="prixprestaConsuCCO'.$i.'" class="prixprestaConsuCCO" value="" placeholder="Tarrif ici..."/>
									</td>';
								...
								if($ligneMedConsult->id_prestationConsu==NULL AND ($ligneMedConsult->prixautreConsu!=0 OR $ligneMedConsult->prixautreConsuCCO!=0))
								{
									...
									<td>
										<input type="text" name="prixprestaConsuCCO[]" style="width:100px; text-align:center" id="prixprestaConsuCCO'.$i.'" class="prixprestaConsuCCO" value="'.$ligneMedConsult->prixautreConsuCCO.'"/>
						...
						<tr style="text-align:center;">
							...
							if($ligneMedInf->id_prestation==NULL AND ($ligneMedInf->prixautrePrestaM==0 OR $ligneMedInf->prixautrePrestaM==0))
							{
								...
								echo $ligneMedInf->autrePrestaM.'<img src="icones/s_warn.png" style="width:20px;height:20px;margin-left:20px;"/></td>
									...
									<td>
										<input type="text" name="prixprestaInfCCO[]" style="width:100px; text-align:center" id="prixprestaInfCCO" class="prixprestaInfCCO" value="" placeholder="Tarrif ici..."/>';
							}else{
...
<input type="hidden" name="idprestaInf[]" style="width:100px;display:none;" id="idprestaInf" value="0"/>
									...
									<td>
									<input type="text" name="prixprestaInfCCO[]" style="width:100px; text-align:center" id="prixprestaInfCCO" class="prixprestaInfCCO" value="'.$ligneMedInf->prixautrePrestaMCCO.'"/>';
								}
							}
							?>
							</td>
						...
						<tr style="text-align:center;<?php if($ligneMedLabo->examenfait==1){ echo 'background:rgba(0,100,255,0.5);';}?>">
							...
							if($ligneMedLabo->id_prestationExa==NULL AND ($ligneMedLabo->prixautreExamen==0 OR $ligneMedLabo->prixautreExamenCCO==0))
							{
								...
								echo $ligneMedLabo->autreExamen.'<img src="icones/s_warn.png" style="width:20px;height:20px;margin-left:20px;"/></td>
									...
									<td>
										<input type="text" name="prixprestaLabCCO[]" style="width:100px; text-align:center" id="prixprestaLabCCO"  class="prixprestaLabCCO" value="" placeholder="Tarrif ici..."/>';
							}else{
								...
								if($ligneMedLabo->id_prestationExa==NULL AND ($ligneMedLabo->prixautreExamen!=0 OR $ligneMedLabo->prixautreExamenCCO!=0))
								{
									...
									<td>
									<input type="text" name="prixprestaLabCCO[]" style="width:100px; text-align:center" id="prixprestaLabCCO"  class="prixprestaLabCCO" value="'.$ligneMedLabo->prixautreExamenCCO.'"/>';
								}
							}
							?>
							</td>
						...
						<tr style="text-align:center;">
							...
							if($ligneMedRadio->id_prestationRadio==NULL AND ($ligneMedRadio->prixautreRadio==0 OR $ligneMedRadio->prixautreRadioCCO==0))
							{
								...
								echo $ligneMedRadio->autreRadio.'<img src="icones/s_warn.png" style="width:20px;height:20px;margin-left:20px;"/></td>
									...
									<td>
										<input type="text" name="prixprestaRadCCO[]" style="width:100px; text-align:center" id="prixprestaRadCCO"  class="prixprestaRadCCO" value="" placeholder="Tarrif ici..."/>';
							}else{
								...
								if($ligneMedRadio->id_prestationRadio==NULL AND ($ligneMedRadio->prixautreRadio!=0 OR $ligneMedRadio->prixautreRadioCCO!=0))
								{
									...
									<td>
									<input type="text" name="prixprestaRadCCO[]" style="width:100px; text-align:center" id="prixprestaRadCCO"  class="prixprestaRadCCO" value="'.$ligneMedRadio->prixautreRadioCCO.'"/>';
								}
							}
							?>
							</td>
						...
						<tr style="text-align:center;">
							...
							if($chekAutreConsom==0 AND ($ligneMedConsom->prixautreConsom==0 OR $ligneMedConsom->prixautreConsomCCO==0))
							{
								...
								echo $ligneMedConsom->autreConsom.'<img src="icones/s_warn.png" style="width:20px;height:20px;margin-left:20px;"/></td>
									...
									<td>
										<input type="text" name="prixprestaConsomCCO[]" style="width:100px; text-align:center" id="prixprestaConsomCCO"  class="prixprestaConsomCCO"  value="" placeholder="Tarrif ici..."/>
									</td>';
							}else{
								...
								if($chekAutreConsom==0 AND ($ligneMedConsom->prixautreConsom!=0 OR $ligneMedConsom->prixautreConsomCCO!=0))
								{
									...
									<td>
										<input type="text" name="prixprestaConsomCCO[]" style="width:100px; text-align:center" id="prixprestaConsomCCO"  class="prixprestaConsomCCO"  value="'.$ligneMedConsom->prixautreConsomCCO.'"/>
						...
						<td>
							...
							if($ligneMedMedoc->id_prestationMedoc==0 AND ($ligneMedMedoc->prixautreMedoc==0 OR $ligneMedMedoc->prixautreMedocCCO==0))
							{
								...
								echo $ligneMedMedoc->autreMedoc.'<img src="icones/s_warn.png" style="width:20px;height:20px;margin-left:20px;"/></td>
									...
									<td>
										<input type="text" name="prixprestaMedocCCO[]" style="width:100px; text-align:center" id="prixprestaMedocCCO" class="prixprestaMedocCCO" value="" placeholder="Tarrif ici..."/>
									</td>';
								...
								if($ligneMedMedoc->id_prestationMedoc==0 AND ($ligneMedMedoc->prixautreMedoc!=0 OR $ligneMedMedoc->prixautreMedocCCO!=0))
								{
									...
									<td>
									<input type="text" name="prixprestaMedocCCO[]" style="width:100px;" id="prixprestaMedocCCO" class="prixprestaMedocCCO" value="'.$ligneMedMedoc->prixautreMedocCCO.'"/>';
								}
...
?>
	...
	{		
		...
		if(more="services" || more==3 || more==12 || more==13 || more==21 || more==22)
		{
			document.getElementById('addbtn').style.display='inline';
