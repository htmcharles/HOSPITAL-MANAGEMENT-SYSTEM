...
<head>
	<title>AFFICHE ORTHOPEDISTES</title>
	...
	<div class="navbar-inner">
		...
		<div class="container">
			...
			<div class="nav-collapse">
				...
				<li class="">			
					<form method="post" action="orthopedistes1.php?<?php if(isset($_GET['codeOrtho'])){ echo 'codeOrtho='.$_GET['codeOrtho'];}?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" onsubmit="return controlFormPassword(this)">
					...
					{
					?>
						<a href="orthopedistes1.php?english=english<?php if(isset($_GET['codeOrtho'])){ echo '&codeOrtho='.$_GET['codeOrtho'];}if(isset($_GET['iduti'])){ echo '&iduti='.$_GET['iduti'];}if(isset($_GET['divOrtho'])){ echo '&divOrtho='.$_GET['divOrtho'];}?>" class="btn"><?php echo getString(30);?></a>
					<?php
					}else{
					?>
						<a href="orthopedistes1.php?francais=francais<?php if(isset($_GET['codeOrtho'])){ echo '&codeOrtho='.$_GET['codeOrtho'];}if(isset($_GET['iduti'])){ echo '&iduti='.$_GET['iduti'];}if(isset($_GET['divOrtho'])){ echo '&divOrtho='.$_GET['divOrtho'];}?>" class="btn"><?php echo getString(29);?></a>
					<?php
					}					
					?>
						<br/>						
...
$(document).ready( function() {
  ...
  $('#q').keyup( function(){
	...
	url : 'traitement_orthopedistes1.php?name=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>' , // url du fichier de traitement
...
$(document).ready( function() {
  ...
  $('#s').keyup( function(){
	...
	url : 'traitement_orthopedistes1.php?sn=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>' , // url du fichier de traitement
	...
	if(isset($_GET['divOrtho']))
	{
		...
		if($comptidA!=0)
		{
			$resultatsA=$connexion->prepare('SELECT *FROM utilisateurs u, orthopedistes o WHERE u.id_u=o.id_u AND o.id_u=:idOrtho AND u.id_u=:idOrtho');
		...
		if($comptidM!=0)
		{
			$resultatsM=$connexion->prepare('SELECT *FROM utilisateurs u, orthopedistes o WHERE u.id_u=o.id_u AND o.id_u=:idOrtho AND u.id_u=:idOrtho');
		...
		<table class="tablesorter" cellspacing="0" style="background-color:#FFF;width:100%;margin-bottom:20px;">
			...
			<tbody>
				...
				<tr style="text-align:center;<?php if($ligneM->status==0){?>background:rgb(253,168,170)<?php ;}?>"> 
					<td><?php echo $ligneM->codeortho;?></td>
					...
					<td><?php echo $ligneM->dateaffectationortho;?></td>
					...
					<td>
						<a href="traitement_utilisateurs.php?idutiDesactif=<?php echo $ligneM->id_u?>&code=<?php echo $ligneM->codeortho;?>&divOrtho=ok<?php if(isset($_GET['page'])){ echo '&page='.$_GET['page'];}else{ echo '&page=1';}?>">Activé<input type="image" style="border-radius:100px;" src="images/onBlue.png" name="desactifbtn"/></a>
					...
					?>
						<td></td>
						<td>
							<a href="traitement_utilisateurs.php?idutiActif=<?php echo $ligneM->id_u?>&code=<?php echo $ligneM->codeortho;?>&divOrtho=ok<?php if(isset($_GET['page'])){ echo '&page='.$_GET['page'];}else{ echo '&page=1';}?>">Desactivé<input type="image" style="border-radius:100px;" src="images/offBlue.png" name="actifbtn"/></a>
	...
	?>
		<table class="tablesorter" cellspacing="0" style="background-color:#FFF;width:100%;margin-bottom:20px;">
			...
			<tbody>
				...
				<tr style="text-align:center;<?php if($ligneA->status==0){?>background:rgb(253,168,170)<?php ;}?>"> 
					<td><?php echo $ligneA->codeortho;?></td>
					...
					<td><?php echo $ligneA->dateaffectationortho;?></td>
		...
		<a href="orthopedistes1.php?iduser=<?php echo $id;?><?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{ if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" style="margin-right:5px;" data-title="Show P&O technicians" class="btn-large">Show P&O technicians</a>
	<?php
	}
	?>
	...
	try
	{
		...
		$resultats=$connexion->query('SELECT *FROM utilisateurs u, orthopedistes o WHERE u.id_u=o.id_u ORDER BY u.nom_u LIMIT '.$limit_start.', '.$pagination.'') or die( print_r($connexion->errorInfo()));
		...
		?>
			<tr style="text-align:center;<?php if($ligne->status==0){?>background:rgb(253,168,170)<?php ;}?>"> 
				<td><?php echo $ligne->codeortho;?></td>
				...
				<td><?php echo $ligne->dateaffectationortho;?></td>
				...
				<td>
					<a href="traitement_utilisateurs.php?idutiDesactif=<?php echo $ligne->id_u?>&code=<?php echo $ligne->codeortho;?><?php if(isset($_GET['page'])){ echo '&page='.$_GET['page'];}else{ echo '&page=1';}?>">Activé<input type="image" style="border-radius:100px;" src="images/onBlue.png" name="desactifbtn" title="Actif"/></a>
				</td>
				<?php
				}else{
				...
				?>
					<td></td>
					<td>
						<a href="traitement_utilisateurs.php?idutiActif=<?php echo $ligne->id_u?>&code=<?php echo $ligne->codeortho;?><?php if(isset($_GET['page'])){ echo '&page='.$_GET['page'];}else{ echo '&page=1';}?>">Desactivé<input type="image" style="border-radius:100px;" src="images/offBlue.png" name="actifbtn" title="Passif"/></a>
	...
	<tr>
		...
		$nb_total=$connexion->query('SELECT COUNT(*) AS nb_total FROM utilisateurs u, orthopedistes o WHERE u.id_u=o.id_u ORDER BY u.nom_u');
