...
if(isset($_POST['checkprestaSurge']))
{
	...
	for($i=0;$i<sizeof($addSurge);$i++)
	{
		...
		$resultatSurge=$connexion->prepare('INSERT INTO med_surge (dateconsu,id_prestationSurge,prixprestationSurge,surgefait,id_assuSurge,insupercentSurge,numero,id_uM,id_consuSurge) VALUES(:dateconsu,:idPrestaSurge,:prixPresta,:surgefait,:idassu,:bill,:numero,:id_uM,:idconsuAdd)');
		...
		for($i=0;$i<sizeof($addSurgeautre);$i++)
		{
			if($addSurgeautre[$i]!="")
			{
				...
				if($ligneLastId=$searchLastId->fetch())
				{
					...
					$resultat=$connexion->prepare('INSERT INTO med_surge (dateconsu,id_prestationSurge,prixprestationSurge,surgefait,id_assuSurge,insupercentSurge,numero,id_uM,id_consuSurge) VALUES(:dateconsu,:idPresta,:prixPresta,:surgefait,:idassu,:bill,:numero,:id_uM,:idconsuAdd)');
					$resultat->execute(array(
					'dateconsu'=>date('Y-m-d', strtotime($dateconsu)),
					'idPresta'=>$lastIdPresta,
...
if(isset($_POST['checkprestaKine']))
{
	...
	for($i=0;$i<sizeof($addKine);$i++)
	{
		...
		$resultatKine=$connexion->prepare('INSERT INTO med_kine (dateconsu,id_prestationKine,prixprestationKine,kinefait,id_assuKine,insupercentKine,numero,id_uM,id_consuKine) VALUES(:dateconsu,:idPrestaKine,:prixPresta,:kinefait,:idassu,:bill,:numero,:id_uM,:idconsuAdd)');
		...
		for($i=0;$i<sizeof($addKineautre);$i++)
		{
			if($addKineautre[$i]!="")
			{
				...
				if($ligneLastId=$searchLastId->fetch())
				{
					...
					$resultat=$connexion->prepare('INSERT INTO med_kine (dateconsu,id_prestationKine,prixprestationKine,kinefait,id_assuKine,insupercentKine,numero,id_uM,id_consuKine) VALUES(:dateconsu,:idPresta,:prixPresta,:kinefait,:idassu,:bill,:numero,:id_uM,:idconsuAdd)');
					$resultat->execute(array(
					'dateconsu'=>date('Y-m-d', strtotime($dateconsu)),
					'idPresta'=>$lastIdPresta,
					'prixPresta'=>$prixKine,
...
if(isset($_POST['checkprestaOrtho']))
{
	...
	for($i=0;$i<sizeof($addOrtho);$i++)
	{
		...
		$resultatOrtho=$connexion->prepare('INSERT INTO med_ortho (dateconsu,id_prestationOrtho,prixprestationOrtho,orthofait,id_assuOrtho,insupercentOrtho,numero,id_uM,id_consuOrtho) VALUES(:dateconsu,:idPrestaOrtho,:prixPresta,:orthofait,:idassu,:bill,:numero,:id_uM,:idconsuAdd)');
		...
		for($i=0;$i<sizeof($addOrthoautre);$i++)
		{
			if($addOrthoautre[$i]!="")
			{
				...
				if($ligneLastId=$searchLastId->fetch())
				{
					...
					$resultat=$connexion->prepare('INSERT INTO med_ortho (dateconsu,id_prestationOrtho,prixprestationOrtho,orthofait,id_assuOrtho,insupercentOrtho,numero,id_uM,id_consuOrtho) VALUES(:dateconsu,:idPresta,:prixPresta,:orthofait,:idassu,:bill,:numero,:id_uM,:idconsuAdd)');
					$resultat->execute(array(
					'dateconsu'=>date('Y-m-d', strtotime($dateconsu)),
					'idPresta'=>$lastIdPresta,
